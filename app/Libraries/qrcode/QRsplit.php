 ...
 */
    class QRsplit {
        ...
        //----------------------------------------------------------------------
        public static function isdigitat(array $str, $pos)
        {    
            if ($pos >= strlen($str)) {
                return false;
            }
        ...
        //----------------------------------------------------------------------
        public static function isalnumat(array $str, $pos)
        {
            if ($pos >= strlen($str)) {
                return false;
            }
        ...
        public function identifyMode($pos): int
        {
            ...
            if ($this->modeHint == QR_MODE_KANJI && $pos+1 < strlen((string) $this->dataStr)) {
        ...
        //----------------------------------------------------------------------
        public static function splitStringToQRinput($string, QRinput $qRinput, $modeHint, $casesensitive = true): ?int
        {
            if(is_null($string) || $string == '\0' || $string == '') {
                throw new Exception('empty string!!!');
            }

            $qRsplit = new QRsplit($string, $qRinput, $modeHint);
