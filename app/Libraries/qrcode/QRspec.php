 ...
 */
    ...
    class QRspec {
        ...
        //----------------------------------------------------------------------
        public static function maximumWords($mode, $version): int|float
        {
            if ($mode == QR_MODE_STRUCTURE) {
                return 3;
            }
        ...
        //----------------------------------------------------------------------
        public static function putAlignmentPattern($version, array &$frame, $width): void
        {
            if ($version < 2) {
                return;
            }
         ...
         */
        public static function putFinderPattern(array &$frame, $ox, $oy): void
        {
            $finder = array(
        ...
        public static function debug($frame, $binary_mode = false): void
        {
            if ($binary_mode) {
                    ...
                    foreach ($frame as &$frameLine) {
                        $frameLine = implode('<span class="m">&nbsp;&nbsp;</span>', explode('0', (string) $frameLine));
                ...
                foreach ($frame as &$frameLine) {
                    $frameLine = implode('<span class="m">&nbsp;</span>',  explode("\xc0", (string) $frameLine));
        ...
        //----------------------------------------------------------------------
        public static function serial($frame): string|false
        {
        ...
        //----------------------------------------------------------------------
        public static function newFrame(?string $version)
        {
        ...
        //----------------------------------------------------------------------
        public static function rsBlockNum($spec): float|int|array     { return $spec[0] + $spec[3]; }
        ...
        public static function rsDataLength($spec): int|float   { return ($spec[0] * $spec[1]) + ($spec[3] * $spec[4]);    }

        public static function rsEccLength($spec): int|float    { return ($spec[0] + $spec[3]) * $spec[2]; }
