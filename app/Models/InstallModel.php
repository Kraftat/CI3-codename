...
class InstallModel extends Model
{
    ...
    public function update_autoload_installed()
    {
        ...
        $autoload_file = str_replace("\$autoload['libraries'] = array('pagination','xmlrpc','form_validation','upload')", "\$autoload['libraries'] = array('database','session','pagination','xmlrpc','form_validation','upload','appLib')", $autoload_file);
    ...
    public function call_CurlApi($post_data)
    {
        ...
        $data = array('domain' => $_SERVER['HTTP_HOST'], 'ip' => $this->getIP(), 'product_name' => config_item('product_name'));
