    ...
    <div class="col-md-12">
        ...
        <?php if(isset($campaignlist)): ?>
            <section class="panel appear-animation" data-appear-animation="<?=$global_config['animations'] ?>" data-appear-animation-delay="100">
                <header class="panel-heading">
                    <h4 class="panel-title"><i class="far fa-list"></i> <?php echo translate('campaign') . " " . translate('reports'); ?></h4>
                </header>
                <div class="panel-body">
...
<div class="zoom-anim-dialog modal-block modal-block-lg mfp-hide" id="modal">
    <section class="panel">
        <header class="panel-heading">
            <h4 class="panel-title"><i class="far fa-list"></i> <?=translate('details')?></h4>
        </header>
        <div class="panel-body">
