...
<div class="row">
	<div class="col-md-12">
		...
		<section class="panel appear-animation" data-appear-animation="<?=$global_config['animations'] ?>" data-appear-animation-delay="100">
			<header class="panel-heading">
				<div class="panel-btn">
					<button class="btn btn-default btn-circle" id="sendWishes" data-loading-text="<i class='far fa-spinner fa-spin'></i> Processing">
						<i class="far fa-comment-dots"></i> <?=translate('send_wishes')?>
					</button>
				</div>
				<h4 class="panel-title"><i class="far fa-user-graduate"></i> <?php echo translate('student') . " " . translate('list');?></h4>
			</header>
