                ...
                <div class="tabs-custom">
                    <ul class="nav nav-tabs txt-font-et">
                        <li class="<?=($step == 1 ? 'active' : ''); ?>">
                            <a href="javascript:void(0);"><i class="far fa-parachute-box"></i> <h5>Requirements</h5></a>
                        </li>
                        <li class="<?=($step == 2 ? 'active' : ''); ?>">
                            <a href="javascript:void(0);"><i class="far fa-laptop-code"></i> <h5>Purchase Code</h5></a>
                        </li>
                        <li class="<?=($step == 3 ? 'active' : ''); ?>">
                            <a href="javascript:void(0);"><i class="far fa-database"></i> <h5>Database</h5></a>
                        </li>
                        <li class="<?=($step == 4 ? 'active' : ''); ?>">
                            <a href="javascript:void(0);"><i class="far fa-server"></i> <h5>Install</h5></a>
                        </li>
                        <li class="<?=($step == 5 ? 'active' : ''); ?>">
                            <a href="javascript:void(0);"><i class="far fa-check"></i> <h5>Completed</h5></a>
                        </li>
                    </ul>
