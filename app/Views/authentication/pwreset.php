                    ...
                    <div class="col-lg-4 col-lg-offset-1 col-md-4 col-md-offset-1 col-sm-12 col-xs-12 no-padding fitxt-center">
                        ...
                        <div class="content">
                            ...
                            <div class="f-social-links center">
                                <a href="<?= $global_config['facebook_url'];?>" target="_blank">
                                    <span class="fab fa-facebook-f"></span>
                                </a>
                                <a href="<?= $global_config['twitter_url'];?>" target="_blank">
                                    <span class="fab fa-twitter"></span>
                                </a>
                                <a href="<?= $global_config['linkedin_url'];?>" target="_blank">
                                    <span class="fab fa-linkedin-in"></span>
                                </a>
                                <a href="<?= $global_config['youtube_url'];?>" target="_blank">
					...
					<div class="col-lg-6 col-lg-offset-right-1 col-md-6 col-md-offset-right-1 col-sm-12 col-xs-12 no-padding">
						<div class="sign-area">
							...
							<form class="form-horizontal" method="post" accept-charset="utf-8">
								<?php echo $this->appLib->generateCSRF(); ?>
