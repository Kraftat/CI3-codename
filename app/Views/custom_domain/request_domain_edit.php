		...
		<ul class="nav nav-tabs">
			<li>
				<a href="<?php echo base_url('custom_domain/mylist') ?>">
					<i class="far fa-globe"></i> <?php echo translate('domain') . " " . translate('list');?>
				</a>
			</li>
			<li class="active">
				<a href="#request" data-toggle="tab">
					<i class="far fa-paper-plane"></i> Edit Request
				</a>
			</li>
		</ul>
		<div class="tab-content">
			<div class="tab-pane box active" id="request">
				...
				<?php if ($customDomain->status == 1) { ?>
					<div class="alert alert-info"><i class="far fa-exclamation-triangle"></i> Editing the URL will re-review it and the custom domain will be disabled until reviewed.</div>
				<?php } ?>
						...
						<div class="row">
							<div class="col-md-2 col-md-offset-3">
								<button type="submit" class="btn btn-default btn-block" data-loading-text="<i class='far fa-spinner fa-spin'></i> Processing">
									<i class="far fa-paper-plane"></i> <?php echo translate('update'); ?>
								</button>
							</div>
						</div>	
					</footer>
