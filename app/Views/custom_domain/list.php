	...
	<div class="col-md-12">
		<section class="panel" >
			<header class="panel-heading">
				<h4 class="panel-title"><i class="far fa-globe"></i> <?php echo translate('domain') . " " . translate('list');?>
					<div class="panel-btn">
						<a class="btn btn-primary btn-circle" href="<?php echo base_url('custom_domain/dns_instruction') ?>"><i class="far fa-question-circle"></i> <?php echo translate('custom_domain') . " " . translate('instruction');?></a>
					</div>
				</h4>
			</header>
