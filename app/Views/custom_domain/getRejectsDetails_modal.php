...
?>
	...
	<header class="panel-heading">
		<h4 class="panel-title"><i class="far fa-bars"></i> <?php echo translate('custom_domain') . " " . translate('reject'); ?></h4>
	</header>
	...
	<footer class="panel-footer">
		<div class="row">
			<div class="col-md-12 text-right">
				<button class="btn btn-default mr-xs" type="submit" data-loading-text="<i class='far fa-spinner fa-spin'></i> Processing"><i class="far fa-times-circle"></i> <?php echo translate('reject'); ?></button>
