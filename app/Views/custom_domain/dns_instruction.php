	...
	<div class="col-md-12">
		<section class="panel" >
			<header class="panel-heading">
				<h4 class="panel-title"><i class="far fa-globe"></i> <?php echo translate('custom_domain') . " " . translate('instruction');?>
					<div class="panel-btn">
						<a class="btn btn-default btn-circle" href="<?php echo base_url('custom_domain/list') ?>"><i class="far fa-arrow-left"></i> <?php echo translate('custom_domain');?></a>
					</div>
				</h4>
			</header>
			...
			<div class="panel-body mb-md">
				...
				<div class="headers-line mt-md"> <i class="far fa-server"></i> DNS <?=translate('settings')?></div>
				<div class="form-group">
			...
			<footer class="panel-footer">
				<div class="row">
					<div class="col-md-2 col-md-offset-3">
						<button type="submit" class="btn btn-default btn-block" data-loading-text="<i class='far fa-spinner fa-spin'></i> Processing"><i class="far fa-plus-circle"></i> Save</button>
					</div>
				</div>	
			</footer>
			<?= form_close(); ?>
