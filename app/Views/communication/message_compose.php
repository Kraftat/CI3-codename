			...
			<div class="row">
				<div class="col-md-12">
					<div class="pull-right">
						<a href="<?php echo base_url('communication/mailbox/compose') ?>" class="btn btn-default mr-xs"><i class="far fa-times"></i><span> <?=translate('discard')?></a>
						<button type="submit" name="submit" value="send" class="btn btn-default" data-loading-text="<i class='far fa-spinner fa-spin'></i> Processing">
