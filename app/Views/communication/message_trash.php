<section class="panel">
    <header class="panel-heading">
        <div class="panel-btn">
            ...
            <button class="btn btn-circle btn-default icon" id="msgAction" data-type="restore" data-toggle="tooltip" data-original-title="<?=translate('restore')?>"><i class="far fa-reply"></i></button>
        ...
        <table class="table text-dark table-hover table-condensed mb-none table-export">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td width="20%"><?=$applicationModel->getUserNameByRoleID($userRoleID, $userID)['name']; ?></td>
