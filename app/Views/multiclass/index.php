...
<div class="row">
	<div class="col-md-12">
		...
		<section class="panel appear-animation" data-appear-animation="<?=$global_config['animations'] ?>" data-appear-animation-delay="100">
			<header class="panel-heading">
				<h4 class="panel-title"><i class="far fa-user-graduate"></i> <?php echo translate('student_list');?></h4>
			</header>
				...
				<table class="table table-bordered table-condensed table-hover table-export">
					...
					<tbody>
						...
						<tr>
							...
							<td class="action">
								<button class="btn btn-circle icon btn-default" data-toggle="tooltip" data-original-title="<?=translate('add_class')?>" data-loading-text="<i class='far fa-spinner fa-spin'></i>" onclick="multiClassView('<?=$row['student_id']?>', this)"><i class="fa fa-plus"></i></button>
							</td>
						</tr>
						<?php endforeach;?>
					</tbody>
	...
	<?php echo form_open('multiclass/saveData', array('class' => 'frm-submit' )); ?>
		<header class="panel-heading">
			<h4 class="panel-title">
				<i class="fa-regular fa-sitemap"></i> <?=translate('class') . " " . translate('list')?>
			</h4>
		</header>
		<div class="panel-body">
		...
		<footer class="panel-footer">
			<div class="row">
				<div class="col-md-12 text-right">
					<button class="btn btn-default mr-xs" data-loading-text="<i class='far fa-spinner fa-spin'></i> Processing" type="submit"><?=translate('save')?></button>
...
<?php endforeach; ?>
		...
		row += '<button type="button" class="btn btn-danger removeTR ml-sm"><i class="far fa-times"></i> </button>';
		row += '</div></td>';
		row += '</tr>';
		return row;
	}
