...
<tr class="iadd">
	<td style="min-width: 160px;">
		<div class="form-group">
			<?php
				$arrayClass = $this->appLib->getClass($row->branch_id);
	...
	<td style="min-width: 160px;">
		<div style="display: flex; align-items: flex-start;">
			<div class="form-group">
				<?php
					$arraySection = $this->appLib->getSections($row->class_id);
...
<?php if ($key != 0): ?>
			<button type="button" class="btn btn-danger removeTR ml-sm"><i class="far fa-times"></i> </button>
<?php endif ?>
		</div>
	</td>
</tr>
