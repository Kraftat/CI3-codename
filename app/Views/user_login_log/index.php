			...
			<div class="tabs-custom">
				...
				<div class="tab-content">
					...
					<?php if (get_permission('user_login_log', 'is_delete')) { ?>
						<button class="btn btn-danger btn-circle mb-md" onclick="confirm_modal('<?php echo base_url('user_login_log/clear') ?>')"><i class="far fa-trash-alt"></i> <?php echo translate('clear_userlog') ?></button>
					<?php } ?>
