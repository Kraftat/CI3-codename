<section class="panel">
	<div class="tabs-custom">
		<ul class="nav nav-tabs">
			<li class="active">
				<a href="#list" data-toggle="tab"><i class="far fa-list-ul"></i> <?=translate('hostel_list')?></a>
			</li>
			...
			<div class="tab-pane" id="create">
				<?php echo form_open($this->uri->uri_string(), array('class' => 'form-horizontal form-bordered frm-submit')); ?>
					...
					<div class="form-group">
						...
						<div class="col-md-6">
							<?php
								$arrayCategory = $this->appLib->getSelectByBranch('hostel_category', $branch_id, false, array('type' => 'hostel'));
