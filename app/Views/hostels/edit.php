<section class="panel">
	<div class="tabs-custom">
		<ul class="nav nav-tabs">
			<li>
				<a href="<?=base_url('hostels')?>"><i class="far fa-list-ul"></i> <?=translate('hostel_list')?></a>
			</li>
			<li class="active">
		...
		<div class="tab-content">
			<div class="tab-pane active" id="create">
					...
					<div class="form-group">
						...
						<div class="col-md-6">
							<?php
								$arrayCategory = $this->appLib->getSelectByBranch('hostel_category', $hostel['branch_id'], false, array('type' => 'hostel'));
