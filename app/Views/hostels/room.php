<section class="panel">
	<div class="tabs-custom">
		<ul class="nav nav-tabs">
			<li class="active">
				<a href="#list" data-toggle="tab"><i class="far fa-list-ul"></i> <?=translate('room_list')?></a>
			</li>
				...
				<table class="table table-bordered table-hover table-export">
					...
					<tbody>
						...
						<tr>
							...
							<td><?= $global_config['currency_symbol'] . $row['bed_fee']; ?></td>
			...
			<div class="tab-pane" id="create">
				<?php echo form_open($this->uri->uri_string(), array('class' => 'form-horizontal form-bordered frm-submit')); ?>
					...
					<div class="form-group">
						...
						<div class="col-md-6">
							<?php
								$arrayHostel = $this->appLib->getSelectByBranch('hostel', $branch_id, false);
					...
					<div class="form-group">
						...
						<div class="col-md-6">
							<?php
								$arrayCategory = $this->appLib->getSelectByBranch('hostel_category', $branch_id, false, array('type' => 'room'));
