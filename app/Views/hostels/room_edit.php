<section class="panel">
	<div class="tabs-custom">
		<ul class="nav nav-tabs">
			<li>
				<a href="<?=base_url('hostels/room')?>"><i class="far fa-list-ul"></i> <?=translate('room_list')?></a>
			</li>
			<li class="active">
			...
			<div class="tab-pane active" id="edit">
				...
				<input type="hidden" name="room_id" value="<?=$room['id']?>">
					...
					<div class="form-group">
						...
						<div class="col-md-6">
							<?php
								$arrayHostel = $this->appLib->getSelectByBranch('hostel', $room['branch_id'], false);
					...
					<div class="form-group">
						...
						<div class="col-md-6">
							<?php
								$arrayCategory = $this->appLib->getSelectByBranch('hostel_category', $room['branch_id'], false, array('type' => 'room'));
