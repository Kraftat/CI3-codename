				...
				<div class="panel-heading">
                    <div class="panel-btn">
						<a href="javascript:void(0);" onclick="mfp_modal('#multipleImport')" class="btn btn-circle btn-default mb-sm">
							<i class="far fa-plus-circle"></i> <?=translate('multiple_import')?>
						</a>
                    </div>
...
<?php } ?>
					...
					<div class="row">
						<div class="col-md-6 mb-sm">
							<div class="form-group">
								...
								<?php
									$department_list = $this->appLib->getDesignation($branch_id);
						...
						<div class="col-md-6 mb-sm">
							<div class="form-group">
								...
								<?php
									$department_list = $this->appLib->getDepartment($branch_id);
					...
					<!-- bank details -->
					<div class="headers-line">
						<i class="far fa-university"></i> <?=translate('bank_details')?>
					</div>
				...
				<footer class="panel-footer">
					<div class="row">
						<div class="col-md-offset-10 col-md-2">
							<button type="submit" name="submit" value="save" class="btn btn btn-default btn-block"> <i class="far fa-plus-circle"></i> <?=translate('save')?></button>
						</div>
					</div>
				</footer>
			<?php echo form_close();?>
...
<div id="multipleImport" class="zoom-anim-dialog modal-block modal-block-lg mfp-hide">
    <section class="panel">
        <div class="panel-heading">
            <h4 class="panel-title"><i class="far fa-plus-circle"></i> <?php echo translate('multiple_import'); ?></h4>
        </div>
				...
				<div class="form-group mt-md">
					<div class="col-md-12 mb-md">
						<a class="btn btn-default pull-right" href="<?=base_url('employee/csv_Sampledownloader')?>">
							<i class='far fa-file-download'></i> Download Sample Import File
						</a>
					</div>
					<div class="col-md-12">
            ...
            <footer class="panel-footer">
                <div class="row">
                    <div class="col-md-12 text-right">
                        <button type="submit" class="btn btn-default mr-xs" id="bankaddbtn" data-loading-text="<i class='far fa-spinner fa-spin'></i> Processing">
                            <i class="far fa-plus-circle"></i> <?php echo translate('import'); ?>
                        </button>
