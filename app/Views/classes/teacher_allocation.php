		...
		<section class="panel">
			...
			<?php echo form_open('classes/teacher_allocation_save', array('class' => 'frm-submit'));?>
				...
				<div class="panel-footer">
					<div class="row">
						<div class="col-md-12">
			                <button type="submit" name="save" value="1" class="btn btn-default pull-right" data-loading-text="<i class='far fa-spinner fa-spin'></i> Processing">
...
<?php endif; ?>
	<div class="col-md-<?php if (get_permission('assign_class_teacher', 'is_add')){ echo "7"; }else{ echo "12"; } ?>">
		<section class="panel">
			<header class="panel-heading">
				<h4 class="panel-title"><i class="far fa-list-ul"></i> <?=translate('class_teacher') . " " . translate('list')?></h4>
			</header>
			<div class="panel-body">
