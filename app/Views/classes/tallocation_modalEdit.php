...
<div class="panel-body">
	...
	<div class="form-group">
		...
		<?php
			$arraySection = $this->appLib->getSections($data['class_id']);
	...
	<div class="form-group mb-md">
		...
		<?php
			$arrayTeacher = $this->appLib->getStaffList($data['branch_id'], 3);
...
<footer class="panel-footer">
	<div class="row">
		<div class="col-md-12 text-right">
			<button class="btn btn-default mr-xs" type="submit" data-loading-text="<i class='far fa-spinner fa-spin'></i> Processing">
