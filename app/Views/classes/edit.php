<section class="panel">
	<div class="tabs-custom">
		<ul class="nav nav-tabs">
			<li>
				<a href="<?=base_url('classes')?>"><i class="far fa-graduation-cap"></i> <?=translate('class')?></a>
			</li>
<?php if (get_permission('section', 'is_view')): ?>
			<li>
				<a href="<?=base_url('sections')?>"><i class="far fa-award"></i> <?=translate('section')?></a>
			</li>
<?php endif; ?>
			<li class="active">
				<a href="#edit" data-toggle="tab"><i class="far fa-pen-nib"></i> <?=translate('edit_class')?></a>
			</li>
		</ul>
				...
				<?php echo form_open($this->uri->uri_string(), array('class' => 'form-horizontal form-bordered frm-submit'));?>
					...
					<div class="form-group">
						...
						<div class="col-md-6 mb-md">
							<?php
								$query = $builder->getWhere("sections_allocation", array('class_id' => $class['id']))->result_array();
