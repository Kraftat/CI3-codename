	...
	<div class="col-md-12">
		...
		<section class="panel appear-animation" data-appear-animation="<?=$global_config['animations'] ?>" data-appear-animation-delay="100">
			...
			<?php if (get_permission('student', 'is_delete')): ?>
				<div class="panel-btn">
					<button class="btn btn-default btn-circle" id="student_bulk_delete" data-loading-text="<i class='far fa-spinner fa-spin'></i> Processing">
						<i class="far fa-trash-alt"></i> <?=translate('bulk_delete')?>
					</button>
				</div>
			<?php endif; ?>
				...
				<table class="table table-bordered table-condensed table-hover table-export">
					...
					<tbody>
						...
						<tr>
							...
							<td class="center"><img class="rounded" src="<?php echo get_image_url('student', $row['photo']); ?>" height="35" width="35"></td>
						...
						<?php } } ?>
							...
							<td class="action">
								...
								<button class="btn btn-circle icon btn-default" data-toggle="tooltip" data-original-title="<?=translate('quick_view')?>" data-loading-text="<i class='far fa-spinner fa-spin'></i>" onclick="studentQuickView('<?=$row['id']?>', this)"><i class="far fa-qrcode"></i></button>
