...
<div class="row">
	<div class="col-md-12">
		...
		<section class="panel appear-animation" data-appear-animation="<?=$global_config['animations'] ?>" data-appear-animation-delay="100">
			<header class="panel-heading">
				<h4 class="panel-title"><i class="far fa-user-graduate"></i> <?php echo translate('login_credential') . " " . translate('reports');?></h4>
			</header>
						...
						<tr>
							...
							<td class="action">
								...
								data-original-title="<?=translate('quick_view')?>">
									<i class="fa-regular fa-lock-open"></i> <?=translate('reset_password')?>
								</a>
							</td>
						</tr>
						<?php endforeach;?>
						...
						<?php echo form_open('student/password_reset/student', array('class' => 'frm-submit'));?>
							...
							<div class="row">
							    <div class="col-md-12 text-right">
							        <button type="submit" class="btn btn btn-default" data-loading-text="<i class='far fa-spinner fa-spin'></i> Processing"><i class="far fa-plus-circle"></i> <?php echo translate('update'); ?></button>
							    </div>
							</div>
						<?= form_close(); ?>
					</div>
			    ...
			    <div class="panel-body">
					...
					<div class="mt-lg">
						<?php echo form_open('student/password_reset/parent', array('class' => 'frm-submit'));?>
							...
							<div class="row">
							    <div class="col-md-12 text-right">
							        <button type="submit" class="btn btn btn-default" data-loading-text="<i class='far fa-spinner fa-spin'></i> Processing"><i class="far fa-plus-circle"></i> Update</button>
							    </div>
							</div>
						<?= form_close(); ?>
					</div>
