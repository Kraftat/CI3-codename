	...
	<div class="col-md-12">
		...
		<section class="panel appear-animation" data-appear-animation="<?=$global_config['animations'] ?>" data-appear-animation-delay="100">
			<header class="panel-heading">
				...
				<h5 class="panel-title"><i class="far fa-id-card-alt"></i> <?=translate('student_list')?></h5>
			</header>
			<div class="panel-body">
				<?php
				if($query->num_rows() != 0){
			...
			<div class="panel-footer">
				<div class="row">
					<div class="col-md-offset-10 col-md-2">
						<button onClick="printElem('id_card_print')" class="btn btn-default btn-block"><i class="far fa-print"></i> <?=translate('print')?></button>
					</div>
				</div>
			</div>
		</section>
