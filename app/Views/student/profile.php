        ...
        <div class="card-body">
            <div class="row justify-content-center">
                ...
                <div class="col-12 col-md-4 col-xl-3 mb-3 mb-md-0 d-flex justify-content-center">
                    <img class="rounded" src="<?php echo get_image_url('student', $student['photo']); ?>" class="img-fluid rounded-circle mx-auto d-block" alt="Profile Picture" style="width: 150px;height: 150px;">
                </div>

                <!-- Profile Details -->
                <div class="col-12 col-md-8 col-xl-9">
                    <h5 class="card-title text-center" style="padding: 0 35px;"><?php echo $student['first_name'] . ' ' . $student['last_name']; ?></h5>
                    <p class="card-text text-center" style="padding: 0 35px;"><small class="text-muted"><?php echo translate('student') . ' / ' . $student['category_name']; ?></small></p>
                    
                    <div class="info-list">
                        <div class="row d-flex justify-content-center" style="margin:20px;">
                            <div class="col-6 col-md-6 col-lg-6 col-xl-6">
                                <strong style="color: #999;"><?=translate('Guardian')?></strong>
                                <p style="padding:5px 0; font-size: 14px;"><?=(!empty($getParent['name']) ? $getParent['name'] : 'N/A'); ?></p>
                            </div>
                            <div class="col-6 col-md-6 col-lg-6 col-xl-6">
                                <strong style="color: #999;"><?=translate('Birthday')?></strong>
                                <p style="padding:5px 0; font-size: 14px;"><?=(!empty($student['birthday']) ? _d($student['birthday']) : 'N/A'); ?></p>
                            </div>
                            <div class="col-6 col-md-6 col-lg-6 col-xl-6">
                                <strong style="color: #999;"><?=translate('Class')?>:</strong>
                                <p style="padding:5px 0; font-size: 14px;"><?= $student['class_name'] . ' (' . $student['section_name'] . ')' ?></p>
                            </div>
                            <div class="col-6 col-md-6 col-lg-6 col-xl-6">
                                <strong style="color: #999;"><?=translate('Mobile No')?></strong>
                                <p style="padding:5px 0; font-size: 14px;"><?=(!empty($student['mobileno']) ? $student['mobileno'] : 'N/A'); ?></p>
                            </div>
                            <div class="col-6 col-md-6 col-lg-6 col-xl-6">
                                <strong style="color: #999;"><?=translate('Email')?>:</strong>
                                <p style="padding:5px 0; font-size: 14px;"><?=(!empty($student['email']) ? $student['email'] : 'N/A'); ?></p>
                            </div>
                            <div class="col-6 col-md-6 col-lg-6 col-xl-6">
                                <strong style="color: #999;"><?=translate('Address')?></strong>
                                <p style="padding:5px 0; font-size: 14px;"><?=(!empty($student['current_address']) ? $student['current_address'] : 'N/A'); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
	...
	<div class="col-md-offset-2 col-md-8">
		<section class="panel pg-fw">
		    <div class="panel-body">
		        <h5 class="chart-title mb-xs text-danger"><i class="far fa-lock"></i> <?php echo translate('student') . " " . translate('deactivated') ?></h5>
		        <div class="mt-lg">
		        	...
		        	<h4 class="mt-lg"><i class="far fa-list"></i> <?php echo translate('deactivated') . " " . translate('history') ?></h4>
					<div class="table-responsive mb-md mt-md">
						<table class="table table-bordered table-hover table-condensed mb-none">
							...
							<tbody>
								...
								$historys = $builder->get('disable_reason_details')->result();
									if (count($historys)) {
	...
	<div class="col-md-12">
		<div class="panel-group" id="accordion">
			...
			<div class="panel panel-accordion">
					...
					<h4 class="panel-title">
                        <div class="auth-pan">
                            <button class="btn btn-default btn-circle" <?php echo $student['active'] == 0 ? 'disabled' : '' ?> id="authentication_btn">
                                <?php if ($student['active'] == 1) { ?><i class="far fa-unlock-alt"></i> <?=translate('authentication')?> <?php } else { ?><i class="far fa-lock"></i> <?=translate('deactivated')?> <?php } ?>
                            </button>
                        </div> 
				...
				<div id="profile" class="accordion-body collapse <?=(session()->getFlashdata('profile_tab') == 1 ? 'in' : ''); ?>">
						...
						<div class="row mb-md">
							...
							<div class="col-md-<?php echo $div; ?> mb-sm">
								<div class="form-group">
									...
									<?php
										$arrayClass = $this->appLib->getClass($branchID);
							...
							<div class="col-md-<?php echo $div; ?> mb-sm">
								<div class="form-group">
									...
									<?php
										$arraySection = $this->appLib->getSections(set_value('class_id', $student['class_id']), true);
...
<?php if ($category['status']) { ?>
							<div class="col-md-<?php echo $div; ?> mb-sm">
								<div class="form-group">
									...
									<?php
										$arrayCategory = $this->appLib->getStudentCategory($branchID);
...
<?php } ?>
						...
						<div class="headers-line mt-md">
							<i class="far fa-user-check"></i> <?=translate('student_details')?>
						</div>
<?php
						...
						<div class="row">
							<div class="col-md-<?php echo $div ?> mb-sm">
								<div class="form-group">
									...
									<div class="input-group">
										<span class="input-group-addon"><i class="far fa-user-graduate"></i></span>
...
<?php } ?>
						...
						<!--guardian details-->
						<div class="headers-line">
							<i class="far fa-user-tie"></i> <?=translate('guardian_details')?>
						</div>
						<div class="row mb-md">
							<div class="col-md-12 mb-md">
								...
								<div class="form-group">
									<?php
										$arrayParent = $this->appLib->getSelectByBranch('parent', $branchID);
					...
					<?php if (moduleIsEnabled('transport')) { ?>
						<!-- transport details -->
						<div class="headers-line">
							<i class="far fa-bus-alt"></i> <?=translate('transport_details')?>
						</div>
						...
						<div class="row mb-md">
							<div class="col-md-6 mb-sm">
								<div class="form-group">
									...
									<?php
										$arrayRoute = $this->appLib->getSelectByBranch('transport_route', $branchID);
							...
							<div class="col-md-6 mb-sm">
								<div class="form-group">
									...
									<?php
										$arrayVehicle = $this->appLib->getVehicleByRoute(set_value('route_id', $student['route_id']));
					...
					<?php if (moduleIsEnabled('hostel')) { ?>
						<!-- hostel details -->
						<div class="headers-line">
							<i class="far fa-hotel"></i> <?=translate('hostel_details')?>
						</div>
						...
						<div class="row mb-md">
							<div class="col-md-6 mb-sm">
								<div class="form-group">
									...
									<?php
										$arrayHostel = $this->appLib->getSelectByBranch('hostel', $branchID);
							...
							<div class="col-md-6 mb-sm">
								<div class="form-group">
									...
									<?php
										$arrayRoom = $this->appLib->getRoomByHostel(set_value('hostel_id', $student['hostel_id']));
...
?>
						...
						<div class="headers-line">
							<i class="far fa-bezier-curve"></i> <?=translate('previous_school_details')?>
						</div>
						<div class="row">
							<div class="col-md-6 mb-sm">
								<div class="form-group">
					...
					<h4 class="panel-title">
						...
						<div class="auth-pan">
							<a href="<?php echo base_url('fees/invoice/' . $student['enrollid']);?>" class="btn btn-default btn-circle btn-collect-fees">
								<i class="far fa-dollar-sign"></i> <?=translate('collect_fees')?>
							</a>
						</div>
						<?php } ?>
						<a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#fees">
							<i class="far fa-money-check"></i> <?=translate('fees')?>
						</a>
					</h4>
				</div>
				...
				<div class="panel-heading">
					<h4 class="panel-title">
						<a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#promotion">
							<i class="far fa-arrow-trend-up"></i> <?=translate('promotion_history')?>
						</a>
					</h4>
				</div>
						...
						<div class="table-responsive mb-md">
							<table class="table table-bordered table-hover table-condensed mb-none">
								...
								<tbody>
									...
									$this->db->where(array('student_id' => $student['id']));
									$this->db->order_by('id', 'asc');
									$historys = $builder->get('promotion_history')->result();
										if (count($historys)) {
											foreach($historys as $history):
												?>
										<tr>
				...
				<div class="panel-heading">
					<h4 class="panel-title">
						<a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#books">
							<i class="far fa-book-reader"></i> <?=translate('book_issue')?>
						</a>
					</h4>
				</div>
						...
						<div class="table-responsive mt-md mb-md">
							<table class="table table-bordered table-hover table-condensed mb-none">
								...
								<tbody>
									...
									$book_result = $builder->get('book_issues')->result_array();
            ...
            <div class="panel panel-accordion">
				<div class="panel-heading">
					<h4 class="panel-title">
						<a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#exam_result">
							<i class="far fa-flask"></i> <?=translate('exam_result')?>
						</a>
					</h4>
				</div>
				<div id="exam_result" class="accordion-body collapse">
					<div class="panel-body">
						...
						$builder->select('timetable_exam.*,exam.type_id,exam.mark_distribution as e_mark_distribution');
						...
						$builder->join('exam', 'exam.id = timetable_exam.exam_id', 'inner');
						$this->db->group_by('exam_id');
						$e_result = $builder->get()->result_array();
						if (!empty($e_result)) {
						...
						?>
					        <section class="panel panel-subl-shadow mt-md mb-md">
					            <header class="panel-heading">
					                <h4 class="panel-title"><?=$applicationModel->exam_name_by_id($examID);?></h4>
					            </header>
					            <div class="panel-body">
									<?php
									...
									$getExam = $builder->select('branch_id')->where(array('id' => $examID))->get('exam')->row_array();
							    ...
							    <?php } else { ?>
									<div class="alert alert-subl mb-none text-center">
										<i class="far fa-exclamation-triangle"></i> <?=translate('no_information_available')?>
									</div>
							    <?php } ?>
					            </div>
					        </section>
				...
				<div class="panel-heading">
					<h4 class="panel-title">
						<a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#parent">
							<i class="far fa-users"></i> <?=translate('parent_information')?>
						</a>
					</h4>
				</div>
				...
				<div class="panel-heading">
					<h4 class="panel-title">
						<a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#sibling">
							<i class="fa-regular fa-people-carry-box"></i> <?=translate('sibling_information')?>
						</a>
					</h4>
				</div>
				...
				<div class="panel-heading">
					<h4 class="panel-title">
						<a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#documents">
							<i class="far fa-folder-open"></i> <?=translate('documents')?>
						</a>
					</h4>
				</div>
                    ...
                    <div class="panel-body">
                        <div class="text-right mb-sm">
                            <a href="javascript:void(0);" onclick="mfp_modal('#addStaffDocuments')" class="btn btn-circle btn-default mb-sm">
                                <i class="far fa-plus-circle"></i> <?php echo translate('add') . " " . translate('document'); ?>
                            </a>
                        </div>
                        <div class="table-responsive mb-md">
                            <table class="table table-bordered table-hover table-condensed mb-none">
                            ...
                            <tbody>
                                ...
                                $documents = $builder->get('student_documents')->result();
                                if (count($documents)) {
