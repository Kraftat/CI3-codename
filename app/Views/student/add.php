	...
	<div class="col-md-12">
		<section class="panel">
			...
			<div class="panel-body">
				...
				<div class="row mb-md">
					...
					<div class="col-md-<?php echo $div; ?> mb-sm">
						<div class="form-group">
							...
							<?php
								$arrayCategory = $this->appLib->getStudentCategory($branch_id);
				...
				<div class="row" id="exist_list" <?php if(set_value('guardian_chk') != true) echo 'style="display: none;"'; ?>>
					<div class="col-md-12 mb-md">
						...
						<div class="form-group">
							<?php
								$arrayParent = $this->appLib->getSelectByBranch('parent', $branch_id);
				...
				<div class="row mb-md">
					<div class="col-md-6 mb-sm">
						<div class="form-group">
							...
							<?php
								$arrayRoute = $this->appLib->getSelectByBranch('transport_route', $branch_id);
				...
				<div class="row mb-md">
					<div class="col-md-6 mb-sm">
						<div class="form-group">
							...
							<?php
								$arrayHostel = $this->appLib->getSelectByBranch('hostel', $branch_id);
			...
			<footer class="panel-footer">
				<div class="row">
					<div class="col-md-offset-10 col-md-2">
						<button type="submit" data-loading-text="<i class='far fa-spinner fa-spin'></i> Processing" class="btn btn btn-default btn-block">
