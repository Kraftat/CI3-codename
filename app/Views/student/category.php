		...
		<section class="panel">
            ...
            <?= form_open(current_url()); ?>
				...
				<div class="panel-footer">
					<div class="row">
						<div class="col-md-12">
							<button class="btn btn-default pull-right" type="submit" name="category" value="1"><i class="far fa-plus-circle"></i> <?php echo translate('save'); ?></button>
						</div>	
					</div>
				</div>
			<?= form_close(); ?>
...
<?php if (get_permission('student_category', 'is_view')): ?>
	<div class="col-md-<?php if (get_permission('student_category', 'is_add')){ echo "7"; }else{ echo "12"; } ?>">
		<section class="panel">
			<header class="panel-heading">
				<h4 class="panel-title"><i class="far fa-list-ul"></i> <?php echo translate('category') . " " . translate('list'); ?></h4>
			</header>
			...
			<div class="panel-body">
				<div class="table-responsive">
					<table class="table table-bordered table-hover table-condensed mb-none">
						...
						$categorylist = $builder->get('student_category')->result_array();
						if (!empty($categorylist)){
							...
							<tr>
								...
								<?php if (get_permission('student_category', 'is_edit')): ?>
									<!-- update link -->
									<button class="btn btn-circle icon btn-default" data-loading-text="<i class='far fa-spinner fa-spin'></i>" onclick="getStudentCategory('<?php echo $row['id']; ?>', this)"><i class="far fa-pen-nib"></i></button>
