	...
	<div class="tabs-custom">
		<ul class="nav nav-tabs">
			<li class="active">
                <a href="#list" data-toggle="tab">
                    <i class="far fa-unlock-alt"></i> <?php echo translate('change') . " " . translate('password'); ?>
                </a>
			</li>
			<li>
                <a href="#login" data-toggle="tab">
                    <i class="far fa-user-lock"></i> <?php echo translate('login') . " " . translate('username'); ?>
                </a>
			</li>
		</ul>
		<div class="tab-content">
					...
					<footer class="panel-footer">
						<div class="row">
							<div class="col-md-2 col-md-offset-3">
								<button type="submit" data-loading-text="<i class='far fa-spinner fa-spin'></i> Processing" class="btn btn-default btn-block"><i class="far fa-key"></i> <?php echo translate('update'); ?></button>
							</div>
						</div>	
					</footer>
				<?= form_close(); ?>
			...
			<div class="tab-pane box" id="login">
				<?php 
				$username = $builder->select('username')->where('id', get_loggedin_id())->get('login_credential')->row()->username;
