	...
	<div class="col-md-12 mb-lg">
		<div class="profile-head">
			...
			<div class="col-md-12 col-lg-5 col-xl-5">
				...
				<ul>
					<li><div class="icon-holder" data-toggle="tooltip" data-original-title="<?=translate('guardian_name')?>"><i class="far fa-users"></i></div> <?=(!empty($getParent['name']) ? $getParent['name'] : 'N/A'); ?></li>
				<?php if (!empty($student['birthday'])) { ?>
					<li><div class="icon-holder" data-toggle="tooltip" data-original-title="<?=translate('birthday')?>"><i class="far fa-birthday-cake"></i></div> <?=_d($student['birthday'])?></li>
				<?php } ?>
					<li><div class="icon-holder" data-toggle="tooltip" data-original-title="<?=translate('class')?>"><i class="far fa-school"></i></div> <?=$student['class_name'] . ' ('.$student['section_name'] . ')'?></li>
					<li><div class="icon-holder" data-toggle="tooltip" data-original-title="<?=translate('mobile_no')?>"><i class="far fa-phone-volume"></i></div> <?=(!empty($student['mobileno']) ? $student['mobileno'] : 'N/A'); ?></li>
					...
					<li><div class="icon-holder" data-toggle="tooltip" data-original-title="<?=translate('present_address')?>"><i class="far fa-home"></i></div> <?=(!empty($student['current_address']) ? $student['current_address'] : 'N/A'); ?></li>
				</ul>
			</div>
		</div>
	</div>
		...
		<section class="panel">
			<div class="tabs-custom">
				<ul class="nav nav-tabs">
					...
					<li>
						<a href="#promotion_history" data-toggle="tab"><i class="far fa-arrow-trend-up"></i> <?=translate('promotion_history')?></a>
					</li>
					<li>
						<a href="#fees" data-toggle="tab"><i class="far fa-money-check"></i> <?=translate('fees')?></a>
					</li>
					<li>
						<a href="#parents" data-toggle="tab"><i class="far fa-users"></i> <?=translate('parent_information')?></a>
					</li>
					<li>
						<a href="#book_issue" data-toggle="tab"><i class="far fa-book-reader"></i> <?=translate('book_issue')?></a>
					</li>
					<li>
						<a href="#documents" data-toggle="tab"><i class="far fa-folder-open"></i> <?=translate('documents')?></a>
					</li>
						...
						<div class="row">
							...
							<div class="col-md-3 mb-sm">
								<div class="form-group">
									...
									<p class="text-dark"><?php $arrayClass = $this->appLib->getClass($branchID); echo $arrayClass[$student['class_id']] ?></p>
							...
							<div class="col-md-3 mb-sm">
								<div class="form-group">
									...
									<p class="text-dark"><?php
										$arraySection = $this->appLib->getSections( $student['class_id'], true);
							...
							<table class="table table-striped table-bordered table-condensed mb-none">
								<tbody>
									...
									<tr>
										...
										<td><?= $global_config['currency_symbol'] . $getParent['income']?></td>
									</tr>
									<tr>
						...
						<div class="panel-footer">
							<div class="row">
								<div class="col-md-offset-9 col-md-3">
									<button class="btn btn-default btn-block" type="submit" data-loading-text="<i class='far fa-spinner fa-spin'></i> Processing"><i class="far fa-plus-circle"></i> <?php echo translate('update'); ?></button>
								</div>	
							</div>
						</div>
					<?= form_close(); ?>
