		...
		<ul class="nav nav-tabs">
			<li class="active">
                <a href="#list" data-toggle="tab">
                    <i class="far fa-list-ul"></i> <?=translate('event_list')?>
                </a>
			</li>
			...
			<div class="tab-pane box active mb-md" id="list">
				<table class="table table-bordered table-hover mb-none tbr-top table-export">
					...
					<tbody>
						...
						$events = $builder->get('event')->result();
						...
						<?php endif; ?>
							...
							<?php if (get_permission('event', 'is_edit')) { ?>
								<!-- edit link -->
								<a href="<?php echo base_url('event/edit/'.$event->id); ?>" class="btn btn-circle btn-default icon"><i class="far fa-pen-nib"></i></a>
							<?php } ?>
					...
					<div class="form-group">
						...
						<div id="typeDiv">
							<div class="mt-md">
								...
								<div class="col-md-6">
									<?php
										$array = $this->appLib->getSelectByBranch('event_types', $branch_id);
