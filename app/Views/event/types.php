				...
				<div class="panel-body">
					...
					<div class="form-group mb-xs">
						...
						<div class="radio-custom radio-success radio-inline">
							...
							<label for="stamp"><i class="far fa-stamp"></i></label>
						</div>
						<div class="radio-custom radio-success radio-inline">
...
<?php if (get_permission('event_type', 'is_view')): ?>
	<div class="col-md-<?php if (get_permission('event_type', 'is_add')){ echo "7"; }else{ echo "12"; } ?>">
		<section class="panel">
			<header class="panel-heading">
				<h4 class="panel-title"><i class="far fa-list-ul"></i> <?=translate('event_type') . " " . translate('list')?></h4>
			</header>
			<div class="panel-body">
					...
					<table class="table table-bordered table-hover table-condensed mb-none">
						...
						<tbody>
							...
							<tr>
								...
								<td><i class="text-xl far fa-<?=html_escape($row['icon'])?>"></i></td>
