    ...
    <div class="col-md-9">
        <section class="panel">
            <header class="panel-heading">
                <h4 class="panel-title"><i class="fa-regular fa-sliders"></i> <?=translate('website_settings')?></h4>
            </header>
                                ...
                                <div class="row">
                                    <div class="col-md-offset-4 col-md-6 mb-md">
                                        <div class="text-right">
                                            <a href="<?php echo base_url('saas/features') ?>" class="btn btn-default btn-circle"><i class="far fa-plus"></i> <?=translate('add') . " " . translate('feature')?></a>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="mt-lg">
                                <div class="row">
                                    <div class="col-md-offset-4 col-md-6 mb-md">
                                        <div class="text-right">
                                            <a href="<?php echo base_url('saas/faqs') ?>" class="btn btn-default btn-circle"><i class="far fa-plus"></i> <?=translate('add') . " " . translate('faq')?></a>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-group">
