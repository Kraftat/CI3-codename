    ...
    <div class="col-md-9">
        <section class="panel">
            <header class="panel-heading">
                <h4 class="panel-title"><i class="fa-regular fa-sliders"></i> <?=translate('general') . " " . translate('settings')?></h4>
            </header>
            <?php echo form_open_multipart('saas/settings_general' . get_request_url(), array('class' => 'form-horizontal  frm-submit-data')); ?>
                <div class="panel-body">
                    ...
                    <section class="panel pg-fw">
                        <div class="panel-body">
                            <h5 class="chart-title mb-xs"><i class="far fa-cog"></i> <?=translate('general')?></h5>
                    ...
                    <section class="panel pg-fw">
                        <div class="panel-body">
                            <h5 class="chart-title mb-xs"><i class="far fa-bell"></i> <?=translate('dashboard') . " " . translate('alert_setting')?></h5>
                            <div class="mt-lg">
                                <div class="form-group">
                    ...
                    <section class="panel pg-fw">
                        <div class="panel-body">
                            <h5 class="chart-title mb-xs"><i class="far fa-search"></i> <?=translate('seo')?></h5>
                            <div class="mt-lg">
                                <div class="form-group">
