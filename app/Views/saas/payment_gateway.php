<div class="row">
		...
		<section class="panel">
			<div class="tabs-custom">
				<ul class="nav nav-tabs">
					...
					<li>
						<a href="#tap" data-toggle="tab">Tap Payments</a>
					</li>
				</ul>
    ...
    <div class="form-group">
        ...
        <div class="col-md-6">
            <input type="text" class="form-control" name="paypal_client_id" value="<?=$config['paypal_client_id']?>">
    ...
    <div class="form-group">
        ...
        <div class="col-md-6">
            <input type="text" class="form-control" name="paypal_client_secret" value="<?=$config['paypal_client_secret']?>">
            <span class="error"></span>
        </div>
    </div>
    <div class="form-group">
    ...
    <?php echo form_close();?>
					...
					<div class="tab-pane box" id="payhere">
						<?php echo form_open('saas/savePaymentConfig', array('class' => 'form-horizontal frm-submit-msg'));?>
							...
							<footer class="panel-footer">
								<div class="row">
									<div class="col-md-3 col-sm-offset-3">
										<button type="submit" class="btn btn btn-default btn-block" data-loading-text="<i class='far fa-spinner fa-spin'></i> Processing" autocomplete="off">
											<i class="far fa-plus-circle"></i> <?=translate('save');?>
										</button>
									</div>
								</div>
					...
					<div class="tab-pane box" id="tap">
        <?php echo form_open('saas/savePaymentConfig', array('class' => 'form-horizontal frm-submit-msg'));?>
            <input type="hidden" name="sandbox" value="tap_demo">
            <div class="form-group">
                <label class="col-sm-3 control-label">Tap Secret Key</label>
                <div class="col-md-6">
                    <input type="text" class="form-control" name="tap_secret_key" value="<?=$config['tap_secret_key']?>" autocomplete="off">
                    <span class="error"></span>
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-3 control-label">Tap Public Key</label>
                <div class="col-md-6">
                    <input type="text" class="form-control" name="tap_public_key" value="<?=$config['tap_public_key']?>" autocomplete="off">
                    <span class="error"></span>
                </div>
            </div>

			<div class="form-group">
            	<label class="col-sm-3 control-label">Tap Merchant ID</label>
           		<div class="col-md-6">
                	<input type="text" class="form-control" name="tap_merchant_id" value="<?=$config['tap_merchant_id']?>" autocomplete="off">
                	<span class="error"></span>
            	</div>
       		</div>
            ...
            <div class="form-group">
                <div class="col-md-offset-3 col-md-6 mb-md">
                    <!-- <div class="checkbox-replace">
                        <label class="i-checks">
                            <input type="checkbox" name="tap_demo" id="tap_demo" <?=($config['tap_demo'] == 1 ? 'checked' : ''); ?>>
                            <i></i> Tap Demo
                        </label>
                    </div> -->
                </div>
		...
		<section class="panel">
			...
			<div class="panel-body">
				...
				<div class="col-md-12">
					<div class="checkbox-replace">
						<label class="i-checks">
							<input type="checkbox" name="tap_status" id="tap_status" <?=($config['tap_status'] == 1 ? 'checked' : ''); ?>>
							<i></i> Tap Payments
						</label>
					</div>
				</div>
			...
			<footer class="panel-footer">
				<button type="submit" class="btn btn btn-default" data-loading-text="<i class='far fa-spinner fa-spin'></i> Processing">
					<?=translate('save')?>
				</button>
			</footer>
			<?php echo form_close();?>
