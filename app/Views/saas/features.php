	...
	<div class="tabs-custom">
		<ul class="nav nav-tabs">
			<li class="<?php echo (!isset($validation_error) ? 'active' : ''); ?>">
				<a href="#list" data-toggle="tab"><i class="far fa-list-ul"></i> <?php echo translate('feature') . " " . translate('list'); ?></a>
			...
			<div class="pull-right pt-sm pb-sm">
			    <a href="<?php echo base_url('saas/website_settings') ?>" class="btn btn-default btn-circle"><i class="far fa-arrow-left"></i> <?= translate('settings')?></a>
			</div>
		</ul>
