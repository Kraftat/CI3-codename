                ...
                <div class="col-lg-4 col-md-4 col-sm-12">
                    ...
                    <ul class="list-unstyled address-list">
                        <li class="clearfix address">
                            <i class="far fa-map-marker-alt"></i> <?php echo $cms_setting['address']; ?>
                        </li>
                        <li class="clearfix">
                            <i class="far fa-phone"></i> <?php echo $cms_setting['mobile_no']; ?>
                        </li>
                        <li class="clearfix">
                            <i class="far fa-fax"></i></i> <?php echo $cms_setting['fax']; ?>
                        </li>
                        <li class="clearfix">
                            <i class="far fa-envelope"></i> <a href="mailto:<?php echo $cms_setting['email']; ?>"><?php echo $cms_setting['email']; ?></a>
                        </li>
                    </ul>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-12">
                    ...
                    <ul class="list-unstyled quick-links">
                        <?php
                            ...
                            if (empty($school)) {
                                ...
                                $r = $builder->select('url_alias')->get_where('front_cms_setting', array('branch_id' => $branchID))->row();
                                $school = $r->url_alias;
                            }
...
$config = $applicationModel->checkArrayDBVal($config, 'whatsapp_chat');
