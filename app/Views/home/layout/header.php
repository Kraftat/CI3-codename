			...
			<div class="row">
				...
				<div class="col-md-6 col-sm-12">
					<ul class="list-unstyled list-inline">
						...
						<li class="list-inline-item"><i class="far fa-phone-volume"></i> <?php echo $cms_setting['mobile_no']; ?></li>
					<?php 
					...
					if (!is_loggedin()) { 
						...
						<li class="list-inline-item"><a href="<?php echo $authenticationURL; ?>"><i class="far fa-user-lock"></i> Login</a></li>
					<?php } else { ?>
						<li class="list-inline-item"><a href="<?php echo base_url('dashboard'); ?>"><i class="far fa-home"></i> Dashboard</a></li>
					<?php } ?>
					</ul>
				</div>
			</div>
    ...
    <div class="container">
        <div class="d-lg-flex align-items-center">
            <div class="latest-title d-flex align-items-center text-nowrap text-white text-uppercase">
                <i class="fa-regular fa-bolt"></i> Latest News
            </div>
