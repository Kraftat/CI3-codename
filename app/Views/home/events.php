                ...
                <div class="inner">
                    ...
                    <ul class="list-unstyled list-inline post-meta">
                        <li class="list-inline-item">
                            <i class="far fa-calendar-day"></i> <?php echo _d($value['start_date']); ?>
                        </li>
                        <li class="list-inline-item">
                            <i class="far fa-calendar-day"></i> <?php echo _d($value['end_date']); ?>
                        </li>
                    </ul>
                    <ul class="list-unstyled list-inline post-meta">
                        <li class="list-inline-item">
                            <i class="far fa-calendar-day"></i> Posted on - <?php echo _d($value['created_at']); ?>
                        </li>
                    </ul>
                    <p>
