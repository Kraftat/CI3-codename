    ...
    <div class="col-md-12">
        <div class="box2 form-box">
	        ...
	        if(session()->getFlashdata('success')) {
	            echo '<div class="alert alert-success"><i class="icon-text-ml far fa-check-circle"></i>' . session()->getFlashdata('success') . '</div>';
	        }
	        ?>
        	<div id="card_holder">
                <button type="button" class="btn btn-1" id="print"><i class="far fa-print"></i> <?=translate('print')?></button>
                <div id="card">
				<style type="text/css">
					@media print {
						.pagebreak {
				...
				<?php $getSchool = $this->db->where(array('id' => $student['branch_id']))->get('branch')->row_array(); ?>
					<div class="mark-container">
						<table border="0" style="margin-top: 20px; height: 100px;">
							<tbody>
								<tr>
									<td style="width:40%;vertical-align: top;"><img style="max-width:225px;" src="<?=$applicationModel->getBranchImage($student['branch_id'], 'report-card-logo')?>"></td>
