...
<div class="container px-md-0 main-container">
    ...
    <div class="box2 form-box position-relative">
        <button type="submit" class="btn btn-1 admission-status-btn" data-bs-toggle="modal" data-bs-target="#admissionModal"><i class="fa-regular fa-file-lines"></i> Check Addmision Status</button>
            ...
            <div class="tab-content clearfix">
                <div class="tab-pane fade show active" id="new-admission" role="tabpanel" aria-labelledby="tab-new-admission">
                    <?php echo form_open_multipart($this->uri->uri_string(), array('class' => 'form-horizontal frm-submit-data')); ?>
                        ...
                        <div class="headers-line mt-3"><i class="far fa-school"></i> Academic Details</div>
                        <div class="row">
                        ...
                        <div class="headers-line mt-3"><i class="far fa-user-graduate"></i> Student Details</div>
                        <div class="row">
                            <?php 
                        ...
                        ?>
                        <div class="headers-line mt-3"><i class="far fa-user-tie"></i> Guardian Details</div>
                        <?php 
                        $div = 6;
                    ...
                    <?php } ?>
                        <button type="submit" class="btn btn-1" data-loading-text="<i class='far fa-spinner fa-spin'></i> Processing"><i class="far fa-plus-circle"></i> <?=translate('submit')?></button>
                    <?= form_close(); ?>
                </div>
            </div>
        </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="submit" data-loading-text="<i class='far fa-spinner fa-spin'></i> Processing" class="btn btn-primary">Check Now</button>
            </div>
            <?= form_close(); ?>
        </div>
    </div>
