					...
					<table class="table table-bordered table-hover table-condensed table_default">
						...
						<tbody>
							...
							<tr>
								...
								<td class="min-w-xs">
									<a class="btn btn-default btn-circle icon" data-toggle="tooltip" data-original-title="<?php echo translate('edit'); ?>" href="<?php echo base_url('role/edit/' . $row['id']); ?>"><i class="far fa-pen-nib"></i></a>
