<section class="panel">
	<div class="tabs-custom">
		<ul class="nav nav-tabs">
			<li>
				<a href="<?=base_url('library/book')?>"><i class="far fa-list-ul"></i> <?=translate('books_list')?></a>
			</li>
			<li class="active">
			...
			<div class="tab-pane active" id="update">
				...
				<input type="hidden" name="book_id" value="<?=$book['id']?>" >
					...
					<div class="form-group">
						...
						<div class="col-md-6">
							<?php
								$array = $this->appLib->getSelectByBranch('book_category', $book['branch_id']);
					...
					<div class="form-group">
						...
						<div class="col-md-6"><input type="file" name="cover_image" class="dropify" data-allowed-file-extensions="jpg png" data-default-file="<?=$applicationModel->get_book_cover_image($book['cover']);?>" /></div>
					</div>
					<div class="form-group">
