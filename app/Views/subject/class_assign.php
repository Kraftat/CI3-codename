<section class="panel">
	<div class="tabs-custom">
		<ul class="nav nav-tabs">
			<li class="active">
				<a href="#list" data-toggle="tab"><i class="far fa-list-ul"></i> <?=translate('assign'). ' ' . translate('list')?></a>
			</li>
					...
					<div class="form-group">
						...
						<div class="col-md-6 mb-md">
							...
							data-plugin-options='{"placeholder": "<?=translate('select_multiple_subject')?>"}'>
								<?php 
								if(!empty($branch_id)):
								$subjects = $builder->getWhere('subject', array('branch_id' => $branch_id))->result();
