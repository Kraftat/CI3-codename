...
if (count($allocations)) {
			...
			<div class="tab-content">
				<div id="invoice" class="tab-pane <?=empty(session()->getFlashdata('pay_tab')) ? 'active' : ''; ?>">
					<div id="invoice_print">
						...
						<div class="text-right mr-lg hidden-print">
							<button onClick="fn_printElem('invoice_print')" class="btn btn-default ml-sm"><i class="far fa-print"></i> <?=translate('print')?></button>
						</div>
					</div>
				</div>
				<?php if ($invoice['status'] != 'unpaid'): ?>
				<div class="tab-pane" id="history">
					<div id="payment_print">
						<div class="invoice payment">
							<header class="clearfix">
								<div class="row">
									<div class="col-xs-6">
										<div class="ib">
											<img src="<?=$applicationModel->getBranchImage($basic['branch_id'], 'printing-logo')?>" alt="Img" />
										</div>
									</div>
									<div class="col-md-6 text-right">
										<h4 class="mt-none mb-none text-dark">Invoice No #<?= $invoice['invoice_no']?></h4>
						...
						<div class="text-right mr-lg hidden-print">
							<button onClick="fn_printElem('payment_print')" class="btn btn-default"><i class="far fa-print"></i> <?=translate('print')?></button>
						</div>
					</div>
				</div>
				<?php endif; ?>
    ...
    <label class="col-md-3 control-label">Payer Name <span class="required">*</span></label>
    <div class="col-md-6">
        <input type="text" class="form-control" name="tap_name" placeholder="Enter customer name" value="" autocomplete="off" />
        <span class="error"></span>
    </div>
</div>
<div class="form-group tap" style="display: none;">
    <label class="col-md-3 control-label">Phone <span class="required">*</span></label>
    <div class="col-md-6">
        <input type="text" class="form-control" name="tap_phone" placeholder="Enter phone number" value="" autocomplete="off" />
        <span class="error"></span>
    </div>
</div>
<div class="form-group tap" style="display: none;">
    <label class="col-md-3 control-label">Email <span class="required">*</span></label>
    <div class="col-md-6">
        <input type="email" class="form-control" name="tap_email" placeholder="Enter email address" value="" autocomplete="off" />
        <span class="error"></span>
    </div>
</div>
								...
								<div class="row">
									<div class="col-md-offset-3 col-md-3">
										<button type="submit" class="btn btn-default" data-loading-text="<i class='far fa-spinner fa-spin'></i> Processing">
											<i class="far fa-credit-card"></i> <?=translate('fees_pay_now')?>
										</button>
									</div>
								</div>
							</footer>
						...
						<div class="mb-xlg">
					        ...
					        <section class="panel pg-fw">
					            <div class="panel-body">
					                <h5 class="chart-title mb-xs"><i class="far fa-credit-card"></i> <?=translate('payment')?></h5>
					                <div class="mt-lg">
										<?php echo form_open_multipart('userrole/offline_payments', array('class' => 'form-horizontal frm-submit-data' )); ?>
			                                ...
			                                <div class="form-group mb-lg">
												<div class="col-md-offset-3 col-md-3">
													<button type="submit" class="btn btn-default" data-loading-text="<i class='far fa-spinner fa-spin'></i> Processing">
														<i class="far fa-credit-card"></i> <?=translate('pay')?>
													</button>
												</div>
											</div>
										<?php echo form_close();?>	
	...
	<section class="panel">
		<div class="panel-body">
			<div class="alert alert-subl mb-none text-center">
				<i class="far fa-exclamation-triangle"></i> <?=translate('no_fees_have_been_allocated')?>
			</div>
		</div>
	</section>
<?php } ?>
