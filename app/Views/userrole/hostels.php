<section class="panel">
	<div class="tabs-custom">
		<ul class="nav nav-tabs">
			<li class="active">
				<a href="#assigned" data-toggle="tab"><i class="far fa-store-alt"></i> <?=translate('assigned')?></a>
			</li>
			<li>
			...
			<div id="assigned" class="tab-pane active">
	            ...
	            <?php else: ?>
					<div class="alert alert-subl text-center">
						<i class="far fa-exclamation-triangle"></i> <?=translate('there_is_no_room_allocation')?>
					</div>
	        	<?php endif;?>
			</div>
			...
			<div class="tab-pane" id="list">
				<table class="table table-bordered table-hover table-export">
					...
					<tbody>
						...
						$rooms = $builder->get('hostel_room')->result();
