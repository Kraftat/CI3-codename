...
?>
		<a href="<?=$joinURL?>" class="joinbtn btn btn-default mt-md mb-md"><i class="far fa-video"></i> <?=translate('join_live_class')?></a>
<?php } else { ?>
		<a href="<?=base_url('userrole/livejoin?meeting_id=' . $row['meeting_id'] . "&live_id=" . $row['id'])?>" class="joinbtn btn btn-default mt-md mb-md"><i class="far fa-video"></i> <?=translate('join_live_class')?></a>
<?php } ?>
	</div>
</div>
