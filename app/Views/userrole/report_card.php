<section class="panel">
    <header class="panel-heading">
        <h4 class="panel-title"><i class="far fa-id-card"></i> <?=translate('report_card')?></h4>
    </header>
    <div class="panel-body">
	<?php
	$builder->select('timetable_exam.*,exam.type_id');
	...
	$variable = $builder->get()->result_array();
	if (!empty($variable)) {
        ...
        <section class="panel panel-subl-shadow mt-md mb-md">
			...
			<div class="mark-container">
				<table class="visible-print" border="0" style="margin-top: 20px; height: 100px;">
					<tbody>
						<tr>
						<td style="width:40%;vertical-align: top;"><img style="max-width:225px;" src="<?=$applicationModel->getBranchImage($getExam['branch_id'], 'report-card-logo')?>"></td>
