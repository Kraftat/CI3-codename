<section class="panel">
    <div class="tabs-custom">
        <ul class="nav nav-tabs">
            <li class="active">
                <a href="#assigned" data-toggle="tab"><i class="far fa-bus"></i> <?=translate('assigned')?></a>
            </li>
            <li>
            ...
            <div id="assigned" class="tab-pane active">
               <?php if(!empty($route)){ ?>
                ...
                <?php
                    ...
                    echo '<div class="alert alert-subl text-center"><i class="far fa-exclamation-triangle"></i> ' . translate('no_information_available') . ' </div>';
                }
                ?>
            </div>
