<section class="panel">
	<div class="tabs-custom">
		<ul class="nav nav-tabs">
			<li>
				<a href="<?php echo base_url('frontend/gallery'); ?>"><i class="far fa-list-ul"></i> <?php echo translate('gallery') . " " . translate('list'); ?></a>
			</li>
			<li class="active">
			...
			<div class="tab-pane active" id="edit">
			    <?php echo form_open_multipart($this->uri->uri_string(), array('class' => 'form-horizontal form-bordered frm-submit-data')); ?>
					...
					<div class="form-group">
						...
						<div class="col-md-6">
							<?php
								$arrayCategory = $this->appLib->getSelectByBranch('front_cms_gallery_category', $gallery['branch_id']);
						...
						<div class="row">
							<div class="col-md-2 col-md-offset-3">
								<button type="submit" class="btn btn-default btn-block" data-loading-text="<i class='far fa-spinner fa-spin'></i> Processing">
									<i class="far fa-edit"></i> <?php echo translate('update'); ?>
								</button>
							</div>
						</div>	
					</footer>
