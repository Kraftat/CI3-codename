...
<?php if (is_superadmin_loggedin() ): ?>
	<?php return view('frontend/branch_select'); ?>
<?php endif; 
if (!empty($branch_id)) {
	?>
...
<section class="panel">
	<div class="tabs-custom">
		<ul class="nav nav-tabs">
			<li class="active">
				<a href="#list" data-toggle="tab"><i class="far fa-list-ul"></i> <?php echo translate('menu') . " " . translate('list'); ?></a>
			</li>
						...
						<tr>
							...
							<td><?php
							 if (!empty($row['submenu'])) {
							 	echo '<i class="far fa-arrow-down"></i>';
							 } else {
							 	echo '-';
							 } ?></td>
							<td>
					...
					<?php if (!empty($row['submenu'])) {
					 ...
					 ?>
						<tr class="sub_menu">
							...
							<td></td>
							<td></td>
							<td><i class="far fa-angle-double-right"></i> <?php echo $value['title'] ?></td>
							<td>
		                        <div class="material-switch ml-xs">
