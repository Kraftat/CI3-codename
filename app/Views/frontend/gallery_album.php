				...
				<div class="panel-heading">
                    <div class="panel-btn">
						<a href="javascript:void(0);" onclick="mfp_modal('#upload')" class="btn btn-circle btn-default mb-sm">
							<i class="far fa-plus-circle"></i> <?=translate('upload')?>
						</a>
                    </div>
					<h4 class="panel-title">
						<i class="far fa-photo-video"></i> <?=translate('album')?>
					</h4>
				</div>
...
<div id="upload" class="zoom-anim-dialog modal-block modal-block mfp-hide">
    <section class="panel">
        <div class="panel-heading">
            <h4 class="panel-title"><i class="far fa-plus-circle"></i> <?php echo translate('upload'); ?></h4>
        </div>
                ...
                <div class="row">
                    <div class="col-md-12 text-right">
                        <button type="submit" class="btn btn-default mr-xs" id="bankaddbtn" data-loading-text="<i class='far fa-spinner fa-spin'></i> Processing">
                            <i class="far fa-upload"></i> <?php echo translate('upload'); ?>
                        </button>
