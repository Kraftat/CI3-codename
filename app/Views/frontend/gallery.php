	...
	<div class="tabs-custom">
		<ul class="nav nav-tabs">
			<li class="<?php echo (!isset($validation_error) ? 'active' : ''); ?>">
				<a href="#list" data-toggle="tab"><i class="far fa-list-ul"></i> <?php echo translate('gallery') . " " . translate('list'); ?></a>
			</li>
					...
					<div class="form-group">
						...
						<div class="col-md-6">
							<?php
								...
								$arrayCategory = $this->appLib->getSelectByBranch('front_cms_gallery_category', $branchID);
