	...
	<div class="col-md-12">
		<section class="panel">
			...
			<header class="panel-heading">
				<h4 class="panel-title"><i class="far fa-plus-circle"></i> <?=translate('edit') . " " . translate('homework')?></h4>
			</header>
			<div class="panel-body mb-md">
				...
				<div class="form-group">
					...
					<div class="col-md-6">
						<?php
							$arrayClass = $this->appLib->getClass($homework['branch_id']);
				...
				<div class="form-group">
					...
					<div class="col-md-6">
						<?php
							$arraySection = $this->appLib->getSections($homework['class_id'], true);
