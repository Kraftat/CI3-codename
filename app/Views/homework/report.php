...
<div class="row">
	<div class="col-md-12">
		...
		<section class="panel appear-animation" data-appear-animation="<?= $global_config['animations'];?>" data-appear-animation-delay="100">
			<header class="panel-heading">
				<h4 class="panel-title"><i class="far fa-list"></i> <?=translate('evaluation_report')?></h4>
			</header>
			<div class="panel-body">
...
<div class="zoom-anim-dialog modal-block modal-block-full mfp-hide" id="modal">
	<section class="panel">
		<header class="panel-heading">
			<h4 class="panel-title"><i class="far fa-bars"></i> <?php echo translate('view_report') . " " . translate('details') ?></h4>
		</header>
		<div class="panel-body">
