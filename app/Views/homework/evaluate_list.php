...
<section class="panel">
	...
	<header class="panel-heading">
		<h4 class="panel-title"><i class="far fa-list"></i> <?=translate('student_list')?></h4>
	</header>
					...
					<tr>
						...
						<td>
							<?php if (!empty($row['enc_name'])) { ?>
								<a href="<?php echo base_url('homework/download_submitted?file=' . $row['enc_name']) ?>" class="btn btn-default btn-sm"><i class="far fa-download"></i></a>
							<?php } else { ?>
								--
							<?php } ?>
						</td>
