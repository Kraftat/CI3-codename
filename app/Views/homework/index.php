...
<div class="row">
	<div class="col-md-12">
			...
			<?php if (get_permission('homework', 'is_add')): ?>
				<div class="panel-btn">
					<a href="<?=base_url('homework/add')?>" id="addLeave" class="btn btn-default btn-circle" >
						<i class="far fa-plus-circle"></i> <?=translate('add') . " " . translate('homework')?>
					</a>
				</div>
			<?php endif; ?>
			</header>
		...
		<section class="panel appear-animation" data-appear-animation="<?= $global_config['animations'];?>" data-appear-animation-delay="100">
			<header class="panel-heading">
				<h4 class="panel-title"><i class="far fa-list"></i> <?=translate('homework')?></h4>
			</header>
			<div class="panel-body">
...
<div class="zoom-anim-dialog modal-block modal-block-lg mfp-hide" id="modal">
	<section class="panel">
		<header class="panel-heading">
			<h4 class="panel-title"><i class="far fa-bars"></i> <?php echo translate('evaluate'); ?></h4>
		</header>
		<div class="panel-body">
