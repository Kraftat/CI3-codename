	...
	<div class="col-md-12">
		<section class="panel">
			...
			<header class="panel-heading">
				<h4 class="panel-title"><i class="far fa-plus-circle"></i> <?=translate('add') . " " . translate('homework')?></h4>
			</header>
					...
					<div class="col-md-6">
						<?php
							if(!empty(set_value('class_id'))) {
								...
								$assigns = $builder->getWhere('subject_assign', array('class_id' => set_value('class_id'), 'section_id' => set_value('section_id')))->result();
