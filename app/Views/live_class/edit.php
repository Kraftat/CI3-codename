		...
		<ul class="nav nav-tabs">
			<li>
                <a href="<?=base_url('live_class');?>">
                    <i class="far fa-list-ul"></i> <?=translate('lessons') ." ". translate('list')?>
                </a>
			</li>
			<li class="active">
		...
		<div class="tab-content">
			<div class="tab-pane active" id="add">
					...
					<div class="form-group">
						...
						<div class="col-md-6">
							<?php
								$arrayClass = $this->appLib->getClass($live['branch_id']);
					...
					<div class="form-group">
						...
						<div class="col-md-6">
							<?php
								...
								$arraySections = $this->appLib->getSections($live['class_id'], false, true);
