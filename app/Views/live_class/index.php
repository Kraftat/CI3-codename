		...
		<ul class="nav nav-tabs">
			<li class="active">
                <a href="#list" data-toggle="tab">
                    <i class="far fa-list-ul"></i> <?=translate('live_class') ." ". translate('list')?>
                </a>
			</li>
...
<?php endif; ?>
							...
							<td class="min-w-c">
								<!-- host link -->
								<button class="btn btn-circle btn-default icon" data-toggle="tooltip" data-original-title="<?=translate('host')?>" data-loading-text="<i class='far fa-spinner fa-spin'></i>" onclick="getHostModal('<?=$row['meeting_id'] . "|" . $row['id'] ?>', this);"><i class="far fa-network-wired"></i></button>
		                                ...
		                                <div class="input-group">
		                                    ...
		                                    <span class="input-group-addon">
		                                        <span class="input-group-text">
		                                            <a style="text-decoration: none;" href="javascript:void(0);" id="textCopy"><i class="far fa-copy"></i></a>
		                                        </span>
		                                    </span>
		                                </div>
		                            </div>
...
<div class="zoom-anim-dialog modal-block modal-block-lg mfp-hide" id="modal">
	<section class="panel">
		<header class="panel-heading">
			<h4 class="panel-title"><i class="far fa-bars"></i> <?php echo translate('live_class') . " " . translate('host'); ?></h4>
		</header>
		<div class="panel-body">
