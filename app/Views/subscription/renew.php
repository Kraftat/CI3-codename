    	...
    	<div class="row">
            <div class="col-xl-8 col-lg-8 content-right-offset">
                ...
                <?php echo form_open('subscription/checkout', array('class' => 'form-horizontal frm-submit' )); ?>
                    ...
                    <button type="submit" name="pay" data-loading-text="<i class='far fa-spinner fa-spin'></i> Processing" class="btn btn-lg btn-default mt-lg mb-lg" id="subscribeNow">Confirm and Pay</button>
            ...
            <div class="col-xl-4 col-lg-4 margin-top-0 margin-bottom-60">
                <div class="boxed-widget summary margin-top-0">
                    ...
                    <div class="boxed-widget-inner">
    <ul>
        <li><?php echo translate('subscription_name') ?> <span><?php echo $package['name']; ?></span></li>
        <li><?php echo translate('subscription_period') ?> <span><?php echo $package['period_value'] . ' ' . ($package['period_type'] == 4 ? translate('year') : ($package['period_type'] == 3 ? translate('month') : translate('days'))); ?></span></li>
    </ul>
</div>
