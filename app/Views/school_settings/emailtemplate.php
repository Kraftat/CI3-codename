		...
		<section class="panel">
			<div class="tabs-custom">
				<ul class="nav nav-tabs">
					...
					<li class="active">
						<a href="#email_triggers" data-toggle="tab"><i class="far fa-sitemap"></i> <?=translate('email_triggers')?></a>
					</li>
				</ul>
											...
											<div class="panel-footer">
												<div class="row">
													<div class="col-md-offset-10 col-md-2">
														<button type="submit" name="submit" value="update" class="btn btn-default btn-block" data-loading-text="<i class='far fa-spinner fa-spin'></i> Processing">
