		...
		<section class="panel">
			<div class="tabs-custom">
				<ul class="nav nav-tabs">
					...
					<li>
						<a href="<?=base_url('school_settings/smstemplate' . $url)?>"><i class="far fa-sitemap"></i> <?=translate('sms_triggers')?></a>
					</li>
				</ul>
					...
					<div id="sms_config" class="tab-pane active">
						<section class="panel panel-custom">
							<div class="panel-heading panel-heading-custom">
								<h4 class="panel-title"><i class="far fa-sms"></i> SMS Gateway</h4>
							</div>
								...
								<div class="row">
									<div class="col-md-offset-3 col-md-6 mb-sm">
										<label class="control-label"><?=translate('activated_sms_gateway')?> <span class="required">*</span></label>
											<?php
												$sms_service_provider = $applicationModel->smsServiceProvider($branch_id);
												$arraySMS = array(
