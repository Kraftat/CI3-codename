    ...
    <div class="col-md-12">
        <section class="panel">
            <header class="panel-heading">
                <h4 class="panel-title"><i class="far fa-school"></i> <?=translate('school') . " " . translate('list')?></h4>
            </header>
            <div class="panel-body">
                <table class="table table-bordered table-hover table-condensed mb-none table_default">
                    ...
                    <tbody>
                        <?php 
                            $count = 1;
                            $branchs = $builder->get('branch')->result();
                        ...
                        <tr>
                            ...
                            <td class="min-w-c">
                                ...
                                <a href="<?=base_url('school_settings?branch_id='.$row->id)?>" class="btn btn-default btn-circle">
                                    <i class="far fa-sliders-h"></i> Configuration
                                </a>
                            </td>
                        </tr>
                        <?php endforeach; ?>
...
<div class="row">
	<div class="col-md-3">
        <?php return view('school_settings/sidebar'); ?>
    </div>
    <div class="col-md-9">
        <section class="panel">
            <header class="panel-heading">
                <h4 class="panel-title"><i class="far fa-school"></i> <?=translate('school_setting')?></h4>
            </header>
                        ...
                        <div class="panel-body">
                            ...
                            <div class="mt-lg">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <?php
                                        $timezones = $this->appLib->timezone_list();
...
<div class="form-group">
    <label class="col-md-3 control-label">
        <?=translate('currency');?> <span class="required">*</span>
    </label>
    <div class="col-md-6">
        <select class="form-control" name="currency" id="currency">
            <?php foreach ($currencies as $currency): ?>
                <option value="<?= $currency['code']; ?>" data-symbol="<?= $currency['symbol']; ?>" <?= set_select('currency', $currency['code'], $currency['code'] == $school['currency']); ?>>
...
<div class="form-group">
    <label class="col-md-3 control-label">
        <?=translate('currency_symbol');?> <span class="required">*</span>
    </label>
    <div class="col-md-6">
        <input type="text" class="form-control" name="currency_symbol" id="currency_symbol" value="<?=$school['symbol']?>" readonly />
        <span class="error"></span>
    </div>
</div>
                            ...
                            <div class="mt-md">
                                <div class="form-group">
                                    <div class="col-md-offset-3 col-md-3">
                                        ...
                                        <input type="file" name="logo_file" class="dropify" data-allowed-file-extensions="png" data-default-file="<?=$applicationModel->getBranchImage($school['id'], 'logo')?>" />
                                    </div>
                                    <div class="col-md-3 mb-md">
                                        <label class="control-label pt-none"><?=translate('text_logo');?></label>
                                        <input type="file" name="text_logo" class="dropify" data-allowed-file-extensions="png" data-default-file="<?=$applicationModel->getBranchImage($school['id'], 'logo-small')?>" />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-md-offset-3 col-md-3">
                                        <label class="control-label pt-none"><?=translate('printing_logo');?></label>
                                        <input type="file" name="print_file" class="dropify" data-allowed-file-extensions="png" data-default-file="<?=$applicationModel->getBranchImage($school['id'], 'printing-logo')?>" />
                                    </div>
                                    <div class="col-md-3 mb-md">
                                        <label class="control-label pt-none"><?=translate('report_card');?></label>
                                        <input type="file" name="report_card" class="dropify" data-allowed-file-extensions="png" data-default-file="<?=$applicationModel->getBranchImage($school['id'], 'report-card-logo')?>" />
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="panel-footer">
                    <div class="row">
                        <div class="col-md-3 col-sm-offset-3">
                            <button type="submit" class="btn btn btn-default btn-block" data-loading-text="<i class='far fa-spinner fa-spin'></i> Processing">
