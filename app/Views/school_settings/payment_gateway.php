<div class="row">
    ...
    <?php echo form_open('settings/tap_save', array('class' => 'form-horizontal frm-submit-msg'));?>
        <input type="hidden" name="branch_id" value="<?=$branch_id?>">
		<div class="form-group">
            <label class="col-sm-3 control-label">Tap Secret Key</label>
            <div class="col-md-6 mb-md">
                <input type="text" class="form-control" name="tap_secret_key" value="<?=$config['tap_secret_key']?>">
                <span class="error"></span>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-6">
                <input type="text" class="form-control" name="tap_public_key" value="<?=$config['tap_public_key']?>">
                <span class="error"></span>
            </div>
        </div>
			...
			<div class="panel-body">
				...
				<div class="form-group">
					<div class="col-md-12">
						<div class="checkbox-replace">
							<label class="i-checks">
								<input type="checkbox" name="tap_status" id="tap" <?=($config['tap_status'] == 1 ? 'checked' : ''); ?>>
								<i></i> Tap Payments
							</label>
						</div>
					</div>
