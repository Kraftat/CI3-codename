		...
		<section class="panel">
			<div class="tabs-custom">
				<ul class="nav nav-tabs">
					...
					<li>
						<a href="<?=base_url('school_settings/emailtemplate' . $url)?>"><i class="far fa-sitemap"></i> <?=translate('email_triggers')?></a>
					</li>
				</ul>
            	...
            	<?php echo form_open('school_settings/send_test_email' . $url, array('class' => 'form-horizontal form-bordered frm-submit')); ?>
	                ...
	                <div class="mt-lg">
						<div class="form-group">
							...
							<?php if (session()->getFlashdata('test-email-success')) { ?>
							...
							<?php } if (session()->getFlashdata('test-email-error')) { ?>
								<div class="alert alert-danger mt-md"><i class="far fa-bug"></i> <?php echo session()->getFlashdata('test-email-error'); ?></div>
							<?php } ?>
							</div>
						</div>
						<div class="form-group">
							<div class="col-md-offset-3 col-md-6">
								<button type="submit" class="btn btn btn-default" data-loading-text="<i class='far fa-spinner fa-spin'></i> Processing"> <i class="far fa-envelope"></i> Test Now</button>
							</div>
						</div>
	                </div>
            	</form>
