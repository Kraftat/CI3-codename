		...
		<?php if (isset($students)):?>
			...
			<?php echo form_open('student_promotion/transfersave', array('class' => 'frm-submit'));?>
								...
								<tr>
									...
									<td >
										<a target="_blank" href="<?php echo base_url('student/profile/' . $row['student_id']);?>" class="btn btn-default btn-circle">
											<i class="far fa-eye"></i> <?=translate('view')?>
										</a>
									</td>
									<td>
				...
				<div class="panel-footer">
					<div class="row">
						<div class="col-md-offset-10 col-md-2">
							<button type="submit" name="submit" value="promote" class="btn btn-default btn-block" data-loading-text="<i class='far fa-spinner fa-spin'></i> Processing">
