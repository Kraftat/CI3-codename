		...
		<section class="panel appear-animation mt-sm" data-appear-animation="<?=$global_config['animations'] ?>" data-appear-animation-delay="100">
			...
			<div class="panel-body">
				<div class="mt-sm mb-md">
					...
					<div class="export_title"><?php echo translate('class'). ' : ' .get_type_name_by_id('class', $class_id) .  ' ( ' .translate('section'). ' : ' .get_type_name_by_id('section', $section_id). ' ) ' . $applicationModel->exam_name_by_id($exam_id) . ' - Attendance Sheet';?></div>
