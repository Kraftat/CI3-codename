...
<div class="row">
	<div class="col-md-12">
		...
		<section class="panel appear-animation" data-appear-animation="<?=$global_config['animations'] ?>" data-appear-animation-delay="100">
			...
			?>
			<header class="panel-heading">
				<h4 class="panel-title"><i class="far fa-users-viewfinder"></i> <?php echo translate('student_list');?></h4>
			</header>
							...
							<tr>
								...
								<td class="action">
									<a href="javascript:void(0);" onclick="getAdminStudentResult('<?php echo $row['id'] ?>','<?php echo $row['student_id'] ?>')" class="btn btn-circle btn-default">
										<i class="far fa-users-viewfinder"></i> <?php echo translate('view') . " " . translate('result') ?>
									</a>
								</td>
							</tr>
							<?php endforeach; } else {
