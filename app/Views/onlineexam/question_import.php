		...
		<?php echo form_open_multipart('onlineexam/questionCsvImport', array( 'class' => 'form-horizontal form-bordered frm-submit-data'));?>	
			<header class="panel-heading">
				<h4 class="panel-title">
					<i class="far fa-file-archive"></i> <?=translate('import')?>
				</h4>
				<div class="panel-btn">
					<a href="<?=base_url('onlineexam/question')?>" class="btn btn-default btn-circle">
						<i class="far fa-list"></i> <?=translate('question') . " " . translate('list')?>
					</a>
				</div>
			</header>
			<div class="panel-body">
			<?php if (session()->getFlashdata('csvimport')): ?>
				<div class="alert-danger p-sm"><?php echo session()->getFlashdata('csvimport'); ?></div>
			<?php endif; ?>
				...
				<div class="row">
					<div class="col-md-offset-3 col-md-2">
						<button type="submit" class="btn btn btn-default btn-block" data-loading-text="<i class='far fa-spinner fa-spin'></i> Processing">
							<i class="far fa-plus-circle"></i> <?=translate('import')?>
						</button>
					</div>
				</div>
			</footer>
