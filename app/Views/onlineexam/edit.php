		...
		<ul class="nav nav-tabs">
			<li>
				<a href="<?php echo base_url('onlineexam') ?>">
				  <i class="far fa-list-ul"></i> <?=translate('online_exam') ." ". translate('list')?>
				</a>
			</li>
			<li class="active">
		...
		<div class="tab-content">
			<div class="tab-pane active" id="add">
					...
					<div class="form-group">
						...
						<div class="col-md-6">
							<?php
								$arrayClass = $this->appLib->getClass($onlineexam['branch_id']);
					...
					<div class="form-group">
						...
						<div class="col-md-6">
							<?php
								...
								$arraySections = $this->appLib->getSections($onlineexam['class_id'], false, true);
