	...
	<div class="col-md-12">
		<section class="panel">
			<header class="panel-heading">
				<h4 class="panel-title"><i class="far fa-file-circle-question"></i> <?=translate('question') . " " . translate('list')?></h4>
			<?php if(get_permission('question_bank', 'is_add')) { ?>
				<div class="panel-btn">
					<a href="<?=base_url('onlineexam/question_add')?>" class="btn btn-default btn-circle">
						<i class="far fa-circle-question"></i> <?=translate('add') . " " . translate('question')?>
					</a>
					<a href="<?=base_url('onlineexam/question_import')?>" class="btn btn-default btn-circle">
						<i class="far fa-plus"></i> <?=translate('question') . " " . translate('import')?>
					</a>
				</div>
			<?php } ?>
			</header>
...
<div class="zoom-anim-dialog modal-block modal-block-lg mfp-hide payroll-t-modal" id="modal">
	<section class="panel">
		<header class="panel-heading">
			<h4 class="panel-title"><i class="far fa-file-circle-question"></i> <?php echo translate('question') . " " . translate('view'); ?></h4>
		</header>
		<div class="panel-body">
