	...
	<div class="col-md-12">
			...
			<header class="panel-heading">
				...
				<div class="panel-btn">
					<a href="<?=base_url('onlineexam')?>" class="btn btn-default btn-circle">
						<i class="far fa-list"></i> <?=translate('online_exam') . " " . translate('list')?>
					</a>
				</div>
			</header>
			...
			<footer class="panel-footer">
				<div class="row">
					<div class="col-md-offset-10 col-md-2">
						<button id="btnFilter" class="btn btn-default btn-block"> <i class="far fa-filter"></i> <?=translate('filter')?></button>
					</div>
				</div>
			</footer>
		</section>
		...
		<section class="panel">
			...
			<footer class="panel-footer">
				<div class="row">
					<div class="col-md-offset-10 col-md-2">
						<button type="submit" data-loading-text="<i class='far fa-spinner fa-spin'></i> Processing" class="btn btn-default btn-block"> <i class="far fa-floppy-disk"></i> <?=translate('assign')?></button>
					</div>
				</div>
			</footer>
			<?php echo form_close();?>
