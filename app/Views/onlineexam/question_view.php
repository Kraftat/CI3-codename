	...
	<table class="table table-striped table-bordered table-condensed mb-none">
		...
		if (!empty($questions[$key])) { ?>
			<tr>
				...
				<td><?php if ($value == $answer) { ?><i class="far fa-circle-check text-xl"></i><?php } else { ?><i class="far fa-ellipsis text-xl"></i><?php } ?></td>
...
<div class="table-responsive mt-md mb-md">
	<table class="table table-striped table-bordered  table-condensed mb-none">
		...
		if (!empty($questions[$key])) { ?>
			<tr>
				<th><?=translate('option') . " " . $value ?></th>
				<td><?php if (in_array($value, $answer)) { ?><i class="far fa-circle-check text-xl"></i><?php } else { ?><i class="far fa-ellipsis text-xl"></i><?php } ?></td>
				<td><?php echo $questions[$key] ?></td>
			</tr>
		<?php } } ?>
		</tbody>
