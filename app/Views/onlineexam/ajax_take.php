	...
	<div class="col-md-5">
		<div class="row">
		   <div class="col-sm-12">
				<section class="panel pg-fw">
				   <div class="panel-body">
				       <h5 class="chart-title mb-xs"><i class="far fa-clock"></i> <?=translate('time') . " " . translate('status')?></h5>
		   ...
		   <div class="col-sm-12">
				<section class="panel pg-fw">
				   <div class="panel-body">
				       <h5 class="chart-title mb-xs"><i class="far fa-circle-question"></i> <?=translate('total_questions_map')?></h5>
				       <div class="mt-lg">
							<nav>
		...
		<div class="box wizard" data-initialize="wizard" id="fueluxWizard">
				...
				<div class="box-body step-content">
					...
					<div class="clearfix step-pane <?=$key == 0 ? 'active' : '' ?>" data-step="<?=$key+1?>">
						<section class="panel pg-fw">
						   <div class="panel-body">
						       <h5 class="chart-title mb-xs"><i class="far fa-clipboard-question"></i> <?=translate('question')?> <?=$key+1?> of <?=$totalQuestions?></h5>
						       <div class="mt-lg">
				...
				<div class="question-answer-button">
					...
					<button class="btn btn-danger mr-xs mt-sm" type="button" name="" onclick="clearAnswer()"><i class="far fa-xmark"></i> Clear Answer</button>
					<?php if ($exam->questions_qty > 2) { ?>
						<button class="btn btn-default mt-sm" type="button" name="" id="finishedbutton" onclick="completeExams()"><i class="far fa-check"></i> <?=translate('submit')?></button>
					<?php } ?>
				</div>
			</div>
			</form>
