	...
	<div class="col-md-12">
		...
		<?php if (isset($students)):?>
			<section class="panel appear-animation" data-appear-animation="<?=$global_config['animations'] ?>" data-appear-animation-delay="100">
				<header class="panel-heading">
					<h4 class="panel-title"><i class="fa-regular fa-person-chalkboard"></i> <?=translate('alumni') . " " . translate('list')?></h4>
				</header>
				<div class="panel-body">
					<div class="mb-md">
								...
								<tr>
									...
									<td class="action">
										<?php if (empty($row['alumni_id'])) {
											...
											<button class="btn btn-circle icon btn-default" data-loading-text="<i class='far fa-spinner fa-spin'></i>" onclick="addAlumni('<?=$row['id']?>', this)"><i class="far fa-plus-circle"></i></button>
										<?php } } else { ?>
											<a class="btn btn-circle icon btn-default" href="tel:<?php echo $row['mobile_no'] ?>"><i class="fa-regular fa-phone"></i></a>
											<?php
											if (get_permission('manage_alumni', 'is_edit')) {
												?>
											<button class="btn btn-circle icon btn-default" data-loading-text="<i class='far fa-spinner fa-spin'></i>" onclick="addAlumni('<?=$row['id']?>', this)"><i class="far fa-pen-nib"></i></button>
										<?php } } ?>
	...
	<section class="panel">
		<header class="panel-heading">
			<h4 class="panel-title">
				<i class="fa-regular fa-person-chalkboard"></i> <?=translate('alumni')?>
			</h4>
		</header>
