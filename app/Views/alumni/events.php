	...
	<div class="col-md-6">
		<section class="panel pg-fw">
		    <div class="panel-body">
		        <h5 class="chart-title mb-xs"><i class="fa-regular fa-stopwatch"></i> <?php echo translate('events') . " " .  translate('list')?></h5>
		        <div class="panel-btn mr-sm mt-xs">
					<button onclick="addAlumni('', this)" data-loading-text="<i class='far fa-spinner fa-spin'></i> Processing" class="btn btn-default btn-circle"> <i class="far fa-plus-circle"></i> <?php echo translate('add') . " " .  translate('events')?></button>
				</div>
		        <div class="mt-lg">
					<table class="table table-bordered table-hover mb-none table_default">
						...
						<tbody>
							...
							$events = $builder->get('alumni_events')->result();
							...
							<tr>
								...
								<td class="action">
									<!-- view modal link -->
									<button onclick="viewEventDetails('<?=$event->id?>',this)" data-loading-text="<i class='far fa-spinner fa-spin'></i>" class="btn btn-circle btn-default icon"> <i class="far fa-eye"></i></button>
								<?php if (get_permission('alumni_events', 'is_edit')) { ?>
									<!-- edit link -->
									<button onclick="addAlumni('<?php echo $event->id ?>', this)" data-loading-text="<i class='far fa-spinner fa-spin'></i>" class="btn btn-circle btn-default icon"> <i class="far fa-pen-nib"></i></button>
								<?php } ?>
	...
	<section class="panel">
		<header class="panel-heading">
			<h4 class="panel-title">
				<i class="fa-regular fa-person-chalkboard"></i> <?=translate('alumni') . " " . translate('event')?>
			</h4>
		</header>
		...
		<footer class="panel-footer">
			<div class="row">
				<div class="col-md-12 text-right">
					<button type="submit" class="btn btn-default mr-xs" data-loading-text="<i class='far fa-spinner fa-spin'></i> Processing">
