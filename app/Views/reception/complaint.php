		...
		<ul class="nav nav-tabs">
			<li class="active">
				<a href="#list" data-toggle="tab">
				  <i class="far fa-list-ul"></i> <?=translate('complaint') ." ". translate('list')?>
				</a>
			</li>
...
<?php endif; ?>		
								...
								<?php } ?>
									<button class="btn btn-circle btn-default icon" data-loading-text="<i class='far fa-spinner fa-spin'></i>" onclick="getPostalRecord('<?php echo $row['id'] ?>', this)"><i class="far fa-mattress-pillow"></i></button>
...
<?php if (get_permission('postal_record', 'is_add')): ?>
			<div class="tab-pane" id="add">
					...
					<div class="form-group">
						...
						<div class="col-md-6">
								<?php
									$arrayBranch = $arrayBranch = $this->appLib->getSelectByBranch('complaint_type', $branch_id);
					...
					<div class="form-group">
						...
						<div class="col-md-6">
								<?php
									$arrayBranch = $this->appLib->getStaffList($branch_id);
...
<div class="zoom-anim-dialog modal-block modal-block-lg mfp-hide" id="modal">
	<section class="panel">
		<header class="panel-heading">
			<h4 class="panel-title"><i class="far fa-mattress-pillow"></i> <?php echo translate('complaint'); ?></h4>
		</header>
...
<div class="zoom-anim-dialog modal-block mfp-hide" id="modalAction">
	<section class="panel">
		...
		<header class="panel-heading">
			<h4 class="panel-title"><i class="far fa-location-crosshairs"></i> <?php echo translate('complaint'); ?></h4>
		</header>
		<div class="panel-body">
			<div class="row">
		...
		<footer class="panel-footer">
			<div class="row">
				<div class="col-md-12 text-right">
					<button type="submit" class="btn btn-default ml-xs" data-loading-text="<i class='far fa-spinner fa-spin'></i> Processing">
