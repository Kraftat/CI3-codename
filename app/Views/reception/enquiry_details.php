		...
		<section class="panel">
			<div class="panel-heading">
				...
				<h4 class="panel-title">
					<i class="far fa-info-circle"></i> <?=translate('enquiry') . " " . translate('details')?>
				</h4>
			</div>
		...
		<div class="row">
			<div class="col-md-12">
				<section class="panel">
					<div class="panel-heading">
						<h4 class="panel-title">
							<i class="far fa-plus-circle"></i> <?=translate('add') . " " . translate('follow_up')?>
						</h4>
					</div>
					...
					<footer class="panel-footer">
						<div class="row">
							<div class="col-md-offset-10 col-md-2">
								<button type="submit" data-loading-text="<i class='far fa-spinner fa-spin'></i> Processing" class="btn btn-default btn-block"> <i class="far fa-plus-circle"></i> <?=translate('save')?></button>
							</div>
						</div>
					</footer>
					<?= form_close(); ?>
		...
		<div class="row">
			<div class="col-md-12">
				<section class="panel">
					<div class="panel-heading">
						<h4 class="panel-title">
							<i class="far fa-phone"></i> <?=translate('follow_up') . " " . translate('list')?>
						</h4>
					</div>
					<div class="panel-body">
						<table class="table table-bordered table-hover mb-none table-condensed table-export">
							...
							<tbody>
								...
								$result = $builder->get('enquiry_follow_up')->result();
								if (!empty($result)) { 
									$count = 1;
