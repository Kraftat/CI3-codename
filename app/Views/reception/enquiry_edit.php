		...
		<ul class="nav nav-tabs">
			<li>
				<a href="<?php echo base_url('reception/enquiry'); ?>">
				  <i class="far fa-list-ul"></i> <?=translate('enquiry') ." ". translate('list')?>
				</a>
			</li>
			<li class="active">
		...
		<div class="tab-content">
			<div class="tab-pane active" id="add">
					...
					<div class="form-group">
						...
						<div class="col-md-6">
								<?php
									$enquiryReference = $this->appLib->getSelectByBranch('enquiry_reference', $branch_id);
					...
					<div class="form-group">
						...
						<div class="col-md-6">
								<?php
									$enquiryResponse = $this->appLib->getSelectByBranch('enquiry_response', $branch_id);
