			...
			<table class="table table-hover text-dark">
				...
				<?php if (!empty($complaint['file'])) { ?>
					<tr>
						...
						<td class="text-left"><a href="<?php echo base_url('reception/download/complaint?file=' . $complaint['file']) ?>" class="btn btn-default btn-circle"><i class="far fa-cloud-download-alt"></i> <?php echo translate('download') ?></a></td>
					</tr>
				<?php } ?>
				</tbody>
			</table>
