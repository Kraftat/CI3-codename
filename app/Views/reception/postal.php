		...
		<ul class="nav nav-tabs">
			<li class="active">
                <a href="#list" data-toggle="tab">
                    <i class="far fa-list-ul"></i> <?=translate('postal_record') ." ". translate('list')?>
                </a>
			</li>
...
<?php endif; ?>		
								...
								<td><?php echo $row['confidential'] == 1 ? translate('yes') . ' <i class="far fa-circle-check"></i>' : translate('no'); ?></td>
								<td>
...
<div class="zoom-anim-dialog modal-block modal-block-lg mfp-hide" id="modal">
	<section class="panel">
		<header class="panel-heading">
			<h4 class="panel-title"><i class="far fa-envelope"></i> <?php echo translate('postal_record'); ?></h4>
		</header>
