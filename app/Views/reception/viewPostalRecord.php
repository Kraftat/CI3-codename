			...
			<table class="table table-hover text-dark">
				<tbody>
					...
					<tr>
						...
						<td class="text-left"><?php echo $postal['confidential'] == 1 ? translate('yes') . ' <i class="far fa-circle-check"></i>' : translate('no'); ?></td>
					</tr>
				<?php if (!empty($postal['file'])) { ?>
					<tr>
						<td colspan="2"><strong><?php echo translate('document') . " " . translate('file'); ?> :</strong></td>
						<td class="text-left"><a href="<?php echo base_url('reception/download/postal?file=' . $postal['file']) ?>" class="btn btn-default btn-circle"><i class="far fa-cloud-download-alt"></i> <?php echo translate('download') ?></a></td>
					</tr>
				<?php } ?>
				</tbody>
			</table>
