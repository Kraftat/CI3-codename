		...
		<ul class="nav nav-tabs">
			<li class="active">
				<a href="#database_backup" data-toggle="tab">
				   <i class="far fa-database"></i> <?=translate('database_list') ?>
				</a>
			</li>
<?php if(get_permission('backup_restore', 'is_add')) {?>
			<li>
				<a href="#restore_database" data-toggle="tab">
				   <i class="far fa-upload"></i> <?=translate('restore_database') ?>
				</a>
			</li>
<?php } ?>
		</ul>
			...
			<div class="col-md-12">
				<div class="pull-right mb-md">
					<a href="<?php echo base_url('backup/create'); ?>" class="btn btn-default btn-sm">
						<i class="far fa-paste"></i> <?=translate('create_backup') ?>
					</a>
				</div>
			</div>
			</div>
					...
					<?php
						...
						<tr>
							...
							<td>
								...
								<i class="far fa-download"></i> <?=translate('download')?>
								</a>
					...
					<div class="row">
						<div class="col-md-2 col-sm-offset-3">
						 <button type="submit" class="btn btn-default btn-block" data-loading-text="<i class='far fa-spinner fa-spin'></i> Processing">
						 	<i class="far fa-cloud-upload-alt"></i> <?=translate('upload')?> SQL
						 </button>
						</div>
					</div>	
				</footer>
