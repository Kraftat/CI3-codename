		...
		<ul class="nav nav-tabs">
			<li class="active">
                <a href="#list" data-toggle="tab">
                    <i class="far fa-list-ul"></i> <?=translate('id_card') ." ". translate('list')?>
                </a>
			</li>
					...
					<div class="form-group studenttags" style="display: none;">
						...
						<div class="col-md-8">
							<?php
								...
								if ($this->appLib->isExistingAddon('qrcode') && moduleIsEnabled('qr_code_attendance')) {
...
<div class="zoom-anim-dialog modal-block modal-block-lg mfp-hide" id="modal">
	<section class="panel">
		<header class="panel-heading">
			<h4 class="panel-title"><i class="far fa-id-card-alt"></i> <?php echo translate('id_card') . " " . translate('view'); ?></h4>
		</header>
