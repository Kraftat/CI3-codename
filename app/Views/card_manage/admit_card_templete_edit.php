		...
		<ul class="nav nav-tabs">
			<li>
                <a href="<?=base_url('card_manage/admit_card_templete')?>">
                    <i class="far fa-list-ul"></i> <?=translate('admit_card') ." ". translate('list')?>
                </a>
			</li>
			<li class="active">
...
<div class="zoom-anim-dialog modal-block modal-block-lg mfp-hide" id="modal">
	<section class="panel">
		<header class="panel-heading">
			<h4 class="panel-title"><i class="far fa-id-card-alt"></i> <?php echo translate('admit_card') . " " . translate('view'); ?></h4>
		</header>
