	...
	<?php if(get_permission('class_timetable', 'is_add')) { ?>
		<div class="panel-btn">
			<a href="<?=base_url('timetable/set_classwise')?>" class="btn btn-default btn-circle">
				<i class="far fa-plus-circle"></i> <?=translate('add') . " " . translate('schedule')?>
			</a>
		</div>
	<?php } ?>
	</header>
...
<?php if(isset($timetables)): ?>
	<section class="panel appear-animation mt-sm" data-appear-animation="<?= $global_config['animations'];?>" data-appear-animation-delay="100">
		<header class="panel-heading">
			...
			<h4 class="panel-title"><i class="far fa-user-clock"></i> <?=translate('schedule') . " " . translate('list')?></h4>
		</header>
		<div class="panel-body">
		...
		<section class="panel">
			<div class="panel-heading">
				<h4 class="panel-title">
					<i class="far fa-pen-nib"></i> <?=translate('schedule') . ' ' . translate('edit')?>
				</h4>
			</div>
