				...
				<div class="row mb-sm">
					...
					<div class="col-md-<?php echo $widget; ?> mb-sm">
						<div class="form-group">
							...
							<?php
								$arraySection = $this->appLib->getSections(set_value('class_id'));
			...
			<footer class="panel-footer">
				<div class="row">
					<div class="col-md-offset-10 col-md-2">
						 <button type="submit" class="btn btn btn-default btn-block"> <i class="far fa-filter"></i> <?=translate('filter')?></button>
					</div>
				</div>
			</footer>
			<?php echo form_close();?>
			...
			<div class="panel-body">
				<section class="panel pg-fw">
				    <div class="panel-body">
							...
							<table class="table table-bordered table-condensed">
								...
								<tbody>
									...
									<td class="min-w-sm">
										<div class="form-group mb-none">
											<div class="input-group">
												<span class="input-group-addon"><i class="far fa-stopwatch"></i></span>
						...
						<div class="row">
							<div class="col-md-offset-10 col-md-2">
								<button class="btn btn-default btn-block" type="submit"><i class="far fa-plus-circle"></i> <?=translate('apply')?></button>
							</div>
						</div>
						</form>
					</div>
						...
						<tbody id="timetable_entry_append">
							...
							<tr class="iadd">
								...
								<td width="20%">
									<div class="form-group">
										...
										$selDis = ($value['break']) ? ' disabled ' : '';
											...
											$subjectAssign = $builder->getWhere('subject_assign', array(
												'class_id' => $class_id,
								...
								<td width="20%">
									<div class="form-group">
										<?php
											$arrayTeacher = $this->appLib->getStaffList($branch_id, 3);
								...
								<td class="timet-td">
									...
									<button type="button" class="btn btn-danger removeTR"><i class="far fa-times"></i> </button>
								</td>
							</tr>
						<?php } } else { ?>
							<tr class="iadd">
				...
				<button type="button" class="btn btn-default mt-xs mb-md" onclick="append_timetable_entry()">
					<i class="far fa-plus-circle"></i> <?=translate('add_more')?>
				</button>
			</div>
			<footer class="panel-footer">
				<div class="row">
					<div class="col-md-offset-10 col-md-2">
						 <button type="submit" id="scheduleBtn" class="btn btn-default btn-block" data-loading-text="<i class='far fa-spinner fa-spin'></i> Processing">
...
<?php endforeach; ?>
				...
				row += '<button type="button" class="btn btn-danger removeTR"><i class="far fa-times"></i> </button>';
				row += '</td>';
				row += '</tr>';
				return row;
			}
