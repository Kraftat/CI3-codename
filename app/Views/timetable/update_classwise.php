							...
							<td width="20%">
								<div class="form-group">
									<?php
										...
										$assigns = $builder->getWhere('subject_assign', array('class_id' => $timetable->class_id, 'section_id' => $timetable->section_id))->result();
	...
	<footer class="panel-footer">
		<div class="row">
			<div class="col-md-offset-10 col-md-2">
				<button type="submit" class="btn btn-default btn-block" data-loading-text="<i class='far fa-spinner fa-spin'></i> Processing"><i class="far fa-pencil-square-o"></i> <?=translate('update')?></button>
			</div>
		</div>
	</footer>
	<?php 
