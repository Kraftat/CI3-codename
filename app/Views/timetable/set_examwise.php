								...
								<td class="min-w-sm">
									<div class="form-group mb-none">
										...
										if(!empty($branch_id)){
											...
											$halls = $builder->getWhere('exam_hall', array('branch_id' => $branch_id))->result();
...
<?php } ?>
					...
					<div class="row">
						<div class="col-md-offset-10 col-md-2">
							<button class="btn btn-default btn-block" data-loading-text="<i class='far fa-spinner fa-spin'></i> Processing">
