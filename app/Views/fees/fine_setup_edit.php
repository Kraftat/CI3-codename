<section class="panel">
	<div class="tabs-custom">
		<ul class="nav nav-tabs">
			<li>
				<a href="<?=base_url('fees/fine_setup')?>"><i class="far fa-list-ul"></i> <?php echo translate('fine') . " " . translate('list'); ?></a>
			</li>
			<li class="active">
			...
			<div class="tab-pane active" id="create">
				<?php echo form_open($this->uri->uri_string(), array('class' => 'form-horizontal form-bordered frm-submit')); ?>
					...
					<div class="form-group">
						...
						<div class="col-md-6">
							<?php
								$arrayGroup = $this->appLib->getSelectByBranch('fee_groups', $fine['branch_id']);
