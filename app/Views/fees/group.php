	...
	<div class="tabs-custom">
		<ul class="nav nav-tabs">
			<li class="<?=empty($branch_id) ? 'active' : ''?>">
				<a href="#list" data-toggle="tab"><i class="far fa-list-ul"></i> <?php echo translate('fees_group') . " " . translate('list'); ?></a>
			</li>
					...
					<table class="table table-bordered table-hover table-condensed table-export">
						...
						<tbody>
							...
							<?php endif; ?>
								...
								$result = $builder->get('fee_groups_details')->result_array();
					...
					<div class="table-responsive">
						<table class="table table-bordered table-hover" id="tableID">
							...
							<?php
								...
								$typeResult = $builder->get('fees_type')->result_array();
								if (count($typeResult)) {
