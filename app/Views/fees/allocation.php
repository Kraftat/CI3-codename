...
<div class="row">
	<div class="col-md-12">
				...
				<?php endif; ?>
					...
					<div class="col-md-<?php echo $widget; ?> mb-sm">
						<div class="form-group">
							...
							<?php
								$arrayGroup = $this->appLib->getSelectByBranch('fee_groups', $branch_id, false, array('system' => 0, 'session_id' => get_session_id()));
		...
		<section class="panel appear-animation" data-appear-animation="<?=$global_config['animations'] ?>" data-appear-animation-delay="100">
			...
			<header class="panel-heading">
				<h4 class="panel-title"><i class="far fa-list"></i> <?php echo translate('student_list');?></h4>
			</header>
