...
<section class="panel">
	<div class="tabs-custom">
		<ul class="nav nav-tabs">
			<li class="active">
				<a href="#list" data-toggle="tab"><i class="far fa-list-ul"></i> <?php echo translate('fine') . " " . translate('list'); ?></a>
			</li>
			...
			<div class="tab-pane" id="create">
				<?php echo form_open($this->uri->uri_string(), array('class' => 'form-horizontal form-bordered frm-submit')); ?>
					...
					<div class="form-group">
						...
						<div class="col-md-6">
							<?php
								$arrayGroup = $this->appLib->getSelectByBranch('fee_groups', $branch_id);
