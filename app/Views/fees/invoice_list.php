...
<?php if (isset($invoicelist)): ?>
		<section class="panel appear-animation" data-appear-animation="<?= $global_config['animations'];?>" data-appear-animation-delay="100">
			...
			<header class="panel-heading">
				<h4 class="panel-title"><i class="far fa-list-ol"></i> <?=translate('invoice_list')?>
					<div class="panel-btn">
						<button type="submit" class="btn btn-default btn-circle" data-loading-text="<i class='far fa-spinner fa-spin'></i> Processing" >
							<i class="fa-regular fa-file-pdf"></i> <?=translate('download')?> PDF
						</button>
						<button type="button" class="btn btn-default btn-circle" id="printBtn" data-loading-text="<i class='far fa-spinner fa-spin'></i> Processing">
					...
					<table class="table table-bordered table-condensed table-hover mb-none tbr-top table-export">
						...
						<tbody>
							...
							<tr>
								...
								<td class="action">
									<button type="button" data-loading-text="<i class='far fa-spinner fa-spin'></i>" data-placement="top" data-toggle="tooltip" data-original-title="<?php echo translate('email') . " " . translate('invoice') ?>" class="btn btn-default icon btn-circle" onclick="pdf_sendByemail('<?=$row['enroll_id']?>', this)"><i class="fa-regular fa-envelope"></i></button>
									<!-- collect payment -->
								...
								<?php } ?>
									<!-- delete link -->
									<a class="btn btn-danger icon btn-circle" onclick="confirm_modal('<?=base_url('fees/invoice_delete/' . $row['enroll_id'])?>')"><i class="far fa-trash-alt"></i></a>
								</td>
							</tr>
							<?php  endforeach; ?>
						</tbody>
