<section class="panel">
	<div class="panel-heading">
		<div class="panel-btn">
			<a href="<?php echo base_url('addons/manage') ?>"  class="btn btn-circle btn-default mb-sm"><i class="fa-regular fa-left-long"></i> <?=translate('addon_manager')?></a>
		</div>
		<h4 class="panel-title"> <i class="far fa-puzzle-piece"></i> Addon Details</h4>
	</div>
						...
						<tr>
							<td colspan="2">
								...
								<div class="col-md-offset-4 col-md-4">
									<button id="update_app" class="btn btn-default btn-block" data-loading-text="<i class='far fa-spinner fa-spin'></i> Processing">
