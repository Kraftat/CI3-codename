<section class="panel appear-animation" data-appear-animation="<?= $global_config['animations']; ?>" data-appear-animation-delay="100">
	<div class="tabs-custom">
		<ul class="nav nav-tabs">
			<li <?=(empty(session()->getFlashdata('active')) ? 'class="active"' : '');?>>
			...
			<li <?=(session()->getFlashdata('active') == 2 ? 'class="active"' : '');?>>
			...
			<li <?=(session()->getFlashdata('active') == 3 ? 'class="active"' : '');?>>
				<a href="#upload" data-toggle="tab">
				   <i class="fab fa-uikit"></i>
				   <span class="hidden-xs"> <?=translate('logo')?></span>
				</a>
			</li>
			<li <?=(session()->getFlashdata('active') == 4 ? 'class="active"' : '');?>>
		...
		<div class="tab-content">
			<div class="tab-pane box <?=(empty(session()->getFlashdata('active')) ? 'active' : '');?>" id="setting">
...
window.onload = function() {
    ...
    document.getElementById('currency_symbol').value = symbol;
				...
				<div class="form-group">
					...
					<div class="col-md-6">
						<?php
						$getAnimationslist = $this->appLib->getAnimationslist();
				...
				<div class="form-group">
					...
					<div class="col-md-6">
						<?php
						$getDateformat = $this->appLib->getDateformat();
			...
			<div class="tab-pane box <?=(session()->getFlashdata('active') == 2 ? 'active' : '');?>" id="theme">
				<?php echo form_open($this->uri->uri_string(), array('class' => 'validate form-horizontal form-bordered')); ?>
				<div class="form-group">
			...
			<div class="tab-pane box <?=(session()->getFlashdata('active') == 3 ? 'active' : '');?>" id="upload">
				...
				<div class="headers-line mt-lg">
					<i class="far fa-sign-out-alt"></i> Login Background
				</div>
				<div class="row mb-ld">
					<div class="col-md-4">
						<div class="form-group">
				...
				<!-- Other background -->
				<div class="headers-line mt-lg">
					<i class="far fa-chalkboard"></i> Other Background
				</div>
				<div class="row mb-ld">
					<div class="col-md-4">
						<div class="form-group">
					...
					<div class="row">
						<div class="col-md-2 col-sm-offset-10">
							<button type="submit" class="btn btn btn-default btn-block" name="submit" value="logo">
								<i class="far fa-upload"></i> <?=translate('upload')?>
							</button>
						</div>
					</div>
				</footer>
			...
			<div class="tab-pane box <?=(session()->getFlashdata('active') == 4 ? 'active' : '');?>" id="file_settings">
				<?php echo form_open('settings/file_types_save', array( 'class' 	=> 'frm-submit-msg' )); ?>
				<div class="mb-lg">
					<!-- settings for image -->
					<div class="headers-line mt-lg">
						<i class="far fa-images"></i> Settings For Image
					</div>

					<div class="form-group">
						<label class="control-label">Allowed Extension <span class="required">*</span></label>
						<textarea class="form-control" rows="4" name="image_extension" placeholder="" autocomplete="off"><?= $global_config['image_extension'] ?></textarea>
						<span class="error"></span>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						<label class="control-label">Allowed Extension <span class="required">*</span></label>
						<textarea class="form-control" rows="4" name="file_extension" placeholder="" autocomplete="off"><?= $global_config['file_extension'] ?></textarea>
						<span class="error"></span>
					</div>
					<div class="form-group">
						<label class="control-label">Upload Size (in KB) <span class="required">*</span></label>
				...
				<footer class="panel-footer">
					<div class="row">
						<div class="col-md-2 col-sm-offset-10">
							<button type="submit" class="btn btn btn-default btn-block" name="submit" value="file_types" data-loading-text="<i class='far fa-spinner fa-spin'></i> Processing">
								<i class="far fa-plus-circle"></i> <?=translate('save')?>
							</button>
						</div>
					</div>
