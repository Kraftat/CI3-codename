		...
		<section class="panel">
			<div class="tabs-custom">
				<ul class="nav nav-tabs">
					<li>
						<a href="<?=base_url('attachments')?>"><i class="far fa-list-ul"></i> <?=translate('attachments')?></a>
					</li>
					<li  class="active">
					...
					<div class="tab-pane active" id="create">
						<?php echo form_open_multipart('attachments/save', array('class' => 'form-bordered form-horizontal frm-submit-data')); ?>
							...
							<div class="form-group">
								...
								<div class="col-md-6">
									<?php
										$arrayType = $this->appLib->getSelectByBranch('attachments_type', $data['branch_id']);
								...
								<div id="class_div" <?php if($data['class_id'] == 'unfiltered') { ?> style="display: none" <?php } ?>>
									<div class="mt-sm">
										...
										<div class="col-md-6">
											...
											<?php
												$arrayClass = $this->appLib->getClass($data['branch_id']);
										...
										<div class="col-md-6">
											<?php
												if(!empty($data['class_id'])){
													...
													$assigns = $builder->select('subject_id')->where('class_id', $data['class_id'])->get('subject_assign')->result();
