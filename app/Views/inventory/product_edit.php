<section class="panel">
	<div class="tabs-custom">
		<ul class="nav nav-tabs">
			<li>
				<a href="<?php echo base_url('inventory/product'); ?>"><i class="far fa-list-ul"></i> <?php echo translate('product') . " " . translate('list'); ?></a>
			</li>
			<li class="active">
					...
					<footer class="panel-footer">
						<div class="row">
							<div class="col-md-offset-3 col-md-2">
								<button type="submit" class="btn btn-default btn-block" data-loading-text="<i class='far fa-spinner fa-spin'></i> Processing"><i class="far fa-edit"></i> <?php echo translate('update'); ?></button>
							</div>
						</div>
					</footer>
				<?= form_close(); ?>
