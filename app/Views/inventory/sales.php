...
<section class="panel">
	<div class="tabs-custom">
		<ul class="nav nav-tabs">
			<li class="active">
				<a href="#productlist" data-toggle="tab"><i class="far fa-list-ul"></i> <?php echo translate('sales') . ' ' . translate('list'); ?></a>
			</li>
...
<?php endif; ?>
							...
							<td><?php echo $applicationModel->getUserNameByRoleID($row['role_id'], $row['user_id'])['name']; ?></td>
							<td>
								<?php
									$labelMode = "";
							...
							<td>
								<a href="<?php echo base_url('inventory/sales_invoice/' . $row['id']); ?>" class="btn btn-circle icon btn-default" data-toggle="tooltip" data-original-title="<?php echo translate('bill_view'); ?>"> <i class="far fa-credit-card"></i></a>
								<?php if (get_permission('product_sales', 'is_delete')): ?>
									<?php echo btn_delete('inventory/sales_delete/' . $row['id']); ?>
								<?php endif; ?>
							</td>
						</tr>
						<?php endforeach; }?>
				...
				<?php echo form_open('inventory/sales_save', array('id' => 'frmSubmit')); ?>
					...
					<?php endif; ?>
						<div class="form-group">
			                ...
			                <div class="col-md-6">
				                <?php
				                    $role_list = $this->appLib->getRoles(1);
						...
						<div class="form-group">
							...
							<div class="col-md-6">
								<input type="text" class="form-control" name="bill_no" value="<?php echo $this->appLib->get_bill_no('sales_bill'); ?>" id="bill_no" />
								<span class="error"></span>
							</div>
						</div>
						<div class="form-group">
						...
						<div class="table-responsive">
							<table class="table table-bordered table-hover mt-md" id="tableID">
								...
								<tfoot>
									<tr>
										<td colspan="6">
											<button type="button" class="btn btn-default" onclick="addRows()"> <i class="far fa-plus-circle"></i> <?php echo translate('add_rows'); ?></button>
						...
						<div class="row">
							<div class="col-md-offset-9 col-md-3">
								<button type="submit" name="purchase" id="savebtn" value="1" class="btn btn-default btn-block" data-loading-text="<i class='far fa-spinner fa-spin'></i> Processing">
									<i class="far fa-plus-circle"></i> <?php echo translate('create') . " " . translate('bill'); ?>
								</button>
							</div>
						</div>
					</footer>
...
<?php
$categorylist = $this->appLib->getTable('product_category');
