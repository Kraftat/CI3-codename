...
<section class="panel">
	<header class="panel-heading">
		<h4 class="panel-title"><i class="far fa-list-ol"></i> <?php echo translate('payment') . " " . translate('report'); ?></h4>
	</header>
	<div class="panel-body">
...
<?php if (get_permission('product_purchase', 'is_view')) { ?>
						<!-- invoice view -->
						<a href="<?php echo base_url('inventory/purchase_bill/' . $row['bill_id'] . "/" . $row['hash']); ?>" class="btn btn-circle icon btn-default" data-toggle="tooltip" data-original-title="<?php echo translate('bill_view'); ?>"> <i class="far fa-eye"></i></a>
<?php } ?>
					</td>
				</tr>
				<?php endforeach; }?>
