                ...
                <div class="panel-footer">
                    <div class="row">
                        <div class="col-md-offset-10 col-md-2">
                            <button type="submit" name="search" value="1" class="btn btn-default btn-block"><i class="far fa-filter"></i> <?php echo translate('filter'); ?></button>
                        </div>
                    </div>
                </div>
            <?= form_close(); ?>
                        ...
                        <table class="table table-bordered table-hover table-condensed table_default" >
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="min-w-c">
                                        <?php if($status == 'paid'): ?>
                                            <a href="<?php echo base_url('payroll/invoice/'.$row->salary_id.'/'.$row->salary_hash); ?>" class="btn btn-default btn-circle"><i class="far fa-eye"></i> <?php echo translate('payslip'); ?></a>
                                         <?php else: ?>
