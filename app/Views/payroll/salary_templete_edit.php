...
<section class="panel">
	<div class="tabs-custom">
		<ul class="nav nav-tabs">
			<li>
				<a href="<?php echo base_url('payroll/salary_template'); ?>"><i class="far fa-list-ul"></i> <?php echo translate('template') . ' ' . translate('list'); ?></a>
			</li>
							...
							<section class="panel panel-custom">
								...
								<div class="panel-body">
									...
									<button type="button" class="btn btn-default mt-md" onclick="addAllowanceRows()">
										<i class="far fa-plus-circle"></i> <?php echo translate('add_rows'); ?>
									</button>
								</div>
							</section>
						</div>
					...
					<footer class="panel-footer">
						<div class="row">
							<div class="col-md-offset-9 col-md-3">
								<button type="submit" name="save" value="1" class="btn btn-default btn-block" data-loading-text="<i class='far fa-spinner fa-spin'></i> Processing">
...
<script type="text/javascript">
	...
	function addAllowanceRows() {
		...
		html_row += '<div class="col-md-2 mt-md text-right"><button type="button" class="btn btn-danger" onclick="deleteAllowancRow(' + iAllowance + ')"><i class="far fa-times"></i> </button></div></div>';
	...
	function addDeductionRows() {
		...
		html_row += '<div class="col-md-2 mt-md text-right"><button type="button" class="btn btn-danger" onclick="deleteDeductionRow(' + iDeduction + ')"><i class="far fa-times"></i> </button></div></div>';
