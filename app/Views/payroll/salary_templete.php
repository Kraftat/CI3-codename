			...
			<div id="template" class="tab-pane active mb-md">
				<table class="table table-bordered table-hover table-condensed mb-none table_default">
					...
					<tbody>
						...
						$templatelist = $builder->get('salary_template')->result_array();
						...
						<tr>
							...
							<td><?= $global_config['currency_symbol'] . $row['basic_salary']; ?></td>
...
<div class="zoom-anim-dialog modal-block modal-block-lg mfp-hide payroll-t-modal" id="modal">
	<section class="panel">
		<header class="panel-heading">
			<h4 class="panel-title"><i class="far fa-bars"></i> <?php echo translate('salary_template'); ?></h4>
		</header>
		<div class="panel-body">
