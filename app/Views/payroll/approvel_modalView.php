<?php
$builder->select('leave_application.*,leave_category.name as type_name,staff.name as staff_name,staff.staff_id as staffid');
$this->db->from('leave_application');
$builder->join('leave_category', 'leave_category.id = leave_application.category_id', 'left');
$builder->join('staff', 'staff.id = leave_application.staff_id', 'left');
...
<?php echo form_open('leave/request_approval/' . $row['id']); ?>
	<header class="panel-heading">
		<h4 class="panel-title"><i class="far fa-bars"></i> <?php echo translate('details'); ?></h4>
	</header>
		...
		<div class="row">
			<div class="col-md-12 text-right">
				<button class="btn btn-default mr-xs" type="submit" name="save" value="1">
					<i class="far fa-plus-circle"></i> <?php echo translate('apply'); ?>
				</button>
