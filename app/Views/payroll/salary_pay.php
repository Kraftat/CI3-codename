<section class="panel appear-animation" data-appear-animation="<?=$global_config['animations'] ?>" data-appear-animation-delay="100">
    <div class="panel-body">
        <div class="row">
            <div class="col-md-8">
                <section class="panel panel-sp-custom">
                    <header class="panel-heading panel-heading-sp-custom">
                        <h4 class="panel-title"><i class="far fa-user-tag"></i> <?=translate('salary_details')?></h4>
                    </header>
											...
											<div class="table-responsive text-dark">
												<table class="table">
													...
													<tbody>
														<?php
															$total_allowance = 0;
															$allowances = $builder->select('name,amount,type')->where(array('salary_template_id' => $employee->template_id, 'type' => 'allowance'))->get('salary_stipend')->result();
															if(count($allowances)){
												...
												<table id="deductiontable" class="table">
													...
													<tbody>
														<?php
															...
															$total_deduction = 0;
															$deductions = $builder->select('name,amount,type')->where(array('salary_template_id' => $employee->template_id, 'type' => 'deduction'))->get('salary_stipend')->result();
															if (count($deductions)):
			...
			<section class="panel panel-sp-custom">
				<header class="panel-heading panel-heading-sp-custom">
					<h4 class="panel-title"><i class="far fa-stamp"></i> <?=translate('continue_to_payment')?></h4>
				</header>
				<div class="panel-body panel-body-sp-custom">
					...
					<div class="form-group">
						...
						<?php
							...
							$types = $builder->getWhere('payment_types', array('branch_id' => $employee->branch_id))->result();
