<?php
$builder->select('advance_salary.*,staff.name as staff_name,staff.staff_id as staffid');
$this->db->from('advance_salary');
$builder->join('staff', 'staff.id = advance_salary.staff_id', 'left');
...
<?php echo form_open('advance_salary');?>
	<header class="panel-heading">
		<h4 class="panel-title"><i class="far fa-list-ol"></i> <?=translate('review')?></h4>
	</header>
