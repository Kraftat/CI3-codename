<div class="row">
	<div class="col-md-12">
			...
			<?php if (get_permission('advance_salary_request', 'is_add')): ?>
				<div class="panel-btn">
					<a href="javascript:void(0);" id="advanceSalary" class="btn btn-default btn-circle" >
						<i class="far fa-plus-circle"></i> <?=translate('advance_salary_request')?>
					</a>
				</div>
			<?php endif; ?>
			</header>
		...
		<section class="panel appear-animation" data-appear-animation="<?=$global_config['animations'] ?>" data-appear-animation-delay="100">
			<header class="panel-heading">
				<h4 class="panel-title"><i class="far fa-users" aria-hidden="true"></i> <?=translate('advance_salary')?></h4>
			</header>
			<div class="panel-body">
...
<div id="advanceSalaryModal" class="zoom-anim-dialog modal-block modal-block-primary mfp-hide">
    <section class="panel">
        <div class="panel-heading">
            <h4 class="panel-title"><i class="far fa-plus-circle"></i> <?php echo translate('advance_salary'); ?></h4>
        </div>
		    ...
		    <footer class="panel-footer">
		        <div class="row">
		            <div class="col-md-12 text-right">
		                <button type="submit" name="request" value="1" class="btn btn-default mr-xs" data-loading-text="<i class='far fa-spinner fa-spin'></i> Processing">
