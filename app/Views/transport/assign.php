						...
						<div class="col-md-6">
							<?php
								if(!empty($branch_id)){
									...
									$stoppages = $builder->getWhere('transport_stoppage', array('branch_id' => $branch_id))->result();
					...
					<div class="form-group">
						...
						<div class="col-md-6 mb-md">
							...
							data-plugin-options='{ "placeholder": "<?=translate('select_multiple_vehicle')?>" }'>
								<?php 
								if(!empty($branch_id)):
									$vehicles = $builder->getWhere('transport_vehicle', array('branch_id' => $branch_id))->result();
