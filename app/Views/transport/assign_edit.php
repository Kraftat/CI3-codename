<section class="panel">
	<div class="tabs-custom">
		<ul class="nav nav-tabs">
			<li>
				<a href="<?=base_url('transport/assign')?>"><i class="far fa-list-ul"></i> <?=translate('assign') . ' ' . translate('list')?></a>
			</li>
			<li class="active">
			...
			<div class="tab-pane active" id="edit">
				<?php echo form_open($this->uri->uri_string(), array('class' => 'form-horizontal form-bordered frm-submit')); ?>
					...
					<div class="form-group">
						...
						<div class="col-md-6">
							<?php
								$arrayRoute = $this->appLib->getSelectByBranch('transport_route', $assign['branch_id']);
					...
					<div class="form-group">
						...
						<div class="col-md-6">
							<?php
								...
								$stoppages = $builder->getWhere('transport_stoppage', array('branch_id' => $assign['branch_id']))->result();
					...
					<div class="form-group">
						...
						<div class="col-md-6 mb-md">
							...
							data-plugin-options='{ "placeholder": "<?=translate('select_multiple_vehicle')?>" }'>
								<?php
								$vehicles = $builder->getWhere('transport_vehicle', array('branch_id' => $assign['branch_id']))->result();
								foreach ($vehicles as $vehicle):
								$query_assign = $builder->getWhere("transport_assign", array(
