	...
	<div class="col-md-12">
		<section class="panel">
			...
			<header class="panel-heading">
				<h4 class="panel-title"><i class="far fa-graduation-cap"></i> <?=translate('student_admission')?></h4>
			</header>
				...
				<div class="row mb-md">
					...
					<div class="col-md-<?php echo $div; ?> mb-sm">
						<div class="form-group">
							...
							<?php
								$arrayClass = $this->appLib->getClass($stuDetails['branch_id']);
					...
					<div class="col-md-<?php echo $div; ?> mb-sm">
						<div class="form-group">
							...
							<?php
								$arraySection = $this->appLib->getSections(set_value('class_id', $stuDetails['class_id']), false);
					...
					<div class="col-md-<?php echo $div; ?> mb-sm">
						<div class="form-group">
							...
							<?php
								$arrayCategory = $this->appLib->getStudentCategory($stuDetails['branch_id']);
					...
					<div class="row mb-md">
						...
						<div class="col-md-3 mb-sm">
							<div class="form-group">
								...
								<div class="input-group">
									<span class="input-group-addon"><i class="far fa-unlock-alt"></i></span>
				...
				<div class="row mb-md">
					<div class="col-md-6 mb-sm">
						<div class="form-group">
							...
							<?php
								$arrayRoute = $this->appLib->getSelectByBranch('transport_route', $stuDetails['branch_id']);
					...
					<div class="col-md-6 mb-sm">
						<div class="form-group">
							...
							<?php
								$arrayVehicle = $this->appLib->getVehicleByRoute(set_value('route_id'));
				...
				<div class="row mb-md">
					<div class="col-md-6 mb-sm">
						<div class="form-group">
							...
							<?php
								$arrayHostel = $this->appLib->getSelectByBranch('hostel', $stuDetails['branch_id']);
					...
					<div class="col-md-6 mb-sm">
						<div class="form-group">
							...
							<?php
								$arrayRoom = $this->appLib->getRoomByHostel(set_value('hostel_id'));
					...
					<div class="col-md-12">
						<div class="pull-right">
							<button onclick="history.go(-1);" class="btn btn btn-default mr-xs">
								<i class="far fa-arrow-left"></i> <?=translate('cancel')?>
							</button>
							<button type="submit" data-loading-text="<i class='far fa-spinner fa-spin'></i> Processing" class="btn btn btn-default">
								<i class="far fa-plus-circle"></i> <?=translate('approved_and_enroll')?>
							</button>
						</div>
					</div>
				</div>
