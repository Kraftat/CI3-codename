...
<section class="panel">
	<div class="tabs-custom">
		<ul class="nav nav-tabs">
			<li>
				<a href="<?=base_url('accounting/voucher_expense')?>"><i class="far fa-list-ul"></i> <?php echo translate('expense') . " " . translate('list'); ?></a>
			</li>
			<li class="active">
			...
			<div class="tab-pane active" id="create">
				<?php echo form_open_multipart($this->uri->uri_string(), array('class' => 'form-horizontal form-bordered frm-submit-data')); ?>
					...
					<div class="form-group">
						...
						<div class="col-md-6">
							<?php
								$accounts_list = $this->appLib->getSelectByBranch('accounts', $expense['branch_id']);
					...
					<div class="form-group">
						...
						<div class="col-md-6">
							<?php
								$arrayVoucherHead = $this->appLib->getSelectByBranch('voucher_head', $expense['branch_id'], false, array('type' => 'expense'));
