...
<section class="panel">
	<div class="tabs-custom">
		<ul class="nav nav-tabs">
			<li class="active">
				<a href="#list" data-toggle="tab"><i class="far fa-list-ul"></i> <?php echo translate('deposit') . " " . translate('list'); ?></a>
			</li>
			...
			<div class="tab-pane" id="create">
				...
				<input type="hidden" name="voucher_type" value="deposit">
					...
					<div class="form-group">
						...
						<div class="col-md-6">
							<?php
								$arrayVoucherHead = $this->appLib->getSelectByBranch('voucher_head', $branch_id, false, array('type' => 'income'));
