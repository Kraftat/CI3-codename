...
<section class="panel">
	<div class="tabs-custom">
		<ul class="nav nav-tabs">
			<li class="active">
				<a href="#list" data-toggle="tab"><i class="far fa-list-ul"></i> <?php echo translate('expense') . " " . translate('list'); ?></a>
			</li>
				...
				<div class="mb-md">
					...
					<table class="table table-bordered table-hover table-condensed table-export">
						...
						<tbody>
							...
							<?php endif; ?>
								<td><?php echo (!empty($row['attachments']) ? '<i class="far fa-paperclip"></i> ' : ''); ?> <?php echo $row['ac_name']; ?></td>
			...
			<div class="tab-pane" id="create">
				...
				<input type="hidden" name="voucher_type" value="expense">
					...
					<div class="form-group">
						...
						<div class="col-md-6">
							<?php
								$accounts_list = $this->appLib->getSelectByBranch('accounts', $branch_id);
					...
					<div class="form-group">
						...
						<div class="col-md-6">
							<?php
								$arrayVoucherHead = $this->appLib->getSelectByBranch('voucher_head', $branch_id, false, array('type' => 'expense'));
