	...
	<div class="col-md-12">
		<section class="panel">
			<header class="panel-heading">
				<h4 class="panel-title"><i class="far fa-list-ol"></i> <?php echo translate('transactions'); ?></h4>
			</header>
			<div class="panel-body">
				...
				<table class="table table-bordered table-hover table-condensed table-export" cellspacing="0" width="100%">
					...
					<tbody>
						...
						<?php endif; ?>
							<td><?php echo (!empty($row['attachments']) ? '<i class="far fa-paperclip"></i> ' : ''); ?> <?php echo html_escape($row['ac_name']); ?></td>
