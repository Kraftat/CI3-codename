...
<section class="panel">
	<div class="tabs-custom">
		<ul class="nav nav-tabs">
			<li>
				<a href="<?=base_url('accounting/voucher_deposit')?>"><i class="far fa-list-ul"></i> <?php echo translate('deposit') . " " . translate('list'); ?></a>
			</li>
			<li class="active">
			...
			<div class="tab-pane active" id="create">
				<?php echo form_open_multipart($this->uri->uri_string(), array('class' => 'form-horizontal form-bordered frm-submit-data')); ?>
					...
					<div class="form-group">
						...
						<div class="col-md-6">
							<?php
								$accounts_list = $this->appLib->getSelectByBranch('accounts', $deposit['branch_id']);
					...
					<div class="form-group">
						...
						<div class="col-md-6">
							<?php
								$arrayVoucherHead = $this->appLib->getSelectByBranch('voucher_head', $deposit['branch_id'], false, array('type' => 'income'));
