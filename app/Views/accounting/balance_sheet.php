...
<div class="row">
				...
				<footer class="panel-footer">
					<div class="row">
						<div class="col-md-offset-10 col-md-2">
							<button type="submit" class="btn btn btn-default btn-block"> <i class="far fa-filter"></i> <?php echo translate('filter'); ?></button>
						</div>
					</div>
				</footer>
			<?= form_close(); ?>
	...
	<?php if(!empty($branch_id)): ?>
		<section class="panel">
			<header class="panel-heading">
				<h4 class="panel-title"><i class="far fa-list-ol"></i> <?php echo translate('balance') . " " . translate('sheet'); ?></h4>
			</header>
			<div class="panel-body">
