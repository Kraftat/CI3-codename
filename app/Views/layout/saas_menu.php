...
<li class="nav-parent <?php if ($main_menu == 'saas' || $main_menu == 'saas_setting' || $main_menu == 'custom_domain' || $main_menu == 'saas_offline_payments') echo 'nav-expanded nav-active';?>">
    <a>
        <i class="far fa-sitemap"></i><span><?=translate('school_subscription')?></span>
    </a>
    <ul class="nav nav-children">
        <li class="<?php if ($sub_page == 'saas/school') echo 'nav-active';?>">
            <a href="<?=base_url('saas/school')?>">
                <span><i class="far fa-caret-right" aria-hidden="true"></i><?=translate('subscription')?></span>
            </a>
        </li>
        <li class="<?php if ($sub_page == 'saas/registration_forms') echo 'nav-active';?>">
            <a href="<?= base_url('saas/registration_forms')?>">
                <span><i class="far fa-caret-right" aria-hidden="true"></i><?= translate('registration_forms') ?></span>
            </a>
        </li>
        <li class="<?php if ($sub_page == 'saas/pending_request' || $sub_page == 'saas/school_approved') echo 'nav-active';?>">
            <a href="<?=base_url('saas/pending_request')?>">
                <span><i class="far fa-caret-right" aria-hidden="true"></i><?=translate('pending_request')?></span>
            </a>
        </li>
        ...
        <li class="<?php if ($sub_page == 'saas_offline_payments/type' || $sub_page == 'offline_payments/type_edit') echo 'nav-active';?>">
            <a href="<?=base_url('saas_offline_payments/type')?>">
                <span><i class="far fa-caret-right" aria-hidden="true"></i><?=translate('offline_payments') . " " . translate('type')?></span>
            </a>
        </li>
    </ul>
</li>
