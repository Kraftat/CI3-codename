...
<!-- html header -->
<?php return view('layout/header.php');?>
...
<?php } ?>
	<section class="body">
		<!-- top navbar-->
		<?php return view('layout/topbar.php');?>
		<div class="inner-wrapper">
			<!-- sidebar -->
			<?php 
			if (is_student_loggedin() || is_parent_loggedin()) {
				return view('userrole/sidebar'); 
			} else {
			...
			<section role="main" class="content-body">
				<header class="page-header">
					<a class="page-title-icon" href="<?php echo base_url('dashboard');?>"><i class="far fa-home"></i></a>
					<h2><?php echo $title;?></h2>
				</header>
				<?php return view($sub_page); ?>
			</section>
		</div>
	</section>

	<!-- JS Script -->
	<?php return view('layout/script.php');?>
    ...
    <?php 
    $config = $applicationModel->whatsappChat();
    ...
    <div class="whatsapp-popup">
        ...
        <div class="popup-content">
            ...
            <div class="whatsapp-content">
                <ul>
                <?php $whatsappAgent = $applicationModel->whatsappAgent(); 
