...
<script src="<?= base_url('assets/vendor/jquery/jquery.min.js') ?>"></script>
    ...
    margin-top: 0; /* Reset any margin that might be pushing it down */
}
...
<header>
        <a href="https://cleve.io">
        <img src="<?= $applicationModel->getBranchImage(9999, 'logo-small') ?>" alt="Logo">
        </a>
    </header>
<main>
  <div class="container middle-page">
    <div class="row">
      ...
      <div class="col-md-6 align-self-center">
        ...
        <h6>The page you are looking for does not exist.
          How you got here is a mystery. But you can click the button below
          to go back.
        </h6>
        <button class="btn btn-primary" style="margin-top:20px;" onclick="history.go(-1);">Take Me Previous Page</button>
      </div>
    </div>
  </div>
</main>
...
<!-- Your existing SVG and HTML content -->
