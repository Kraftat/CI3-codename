...
<head>
    ...
    <title><?= $global_config['institute_name'];?></title>
            ...
            <section class="container">
                <div class="row">
                    <div class="col-md-6" style="margin: auto 0;">
                        ...
                        <span style="font-weight: bold; color: #4d4d4d; font-size: 22px;"><?= $global_config['currency_symbol'] .  number_format($get_school['price'] - $get_school['discount'], 2, '.', ''); ?></span>
                        <div class="pasha-image"> 
                            <img src="<?=base_url('uploads/app_image/logo-small.png')?>"/>
                        </div>
                        <div class="compliance">
                        <img src="https://cleve.io/uploads/app_image/gdpr-bage.png" class="compliance-logo" alt="GDPR Compliance Badge">
                        <img src="https://cleve.io/uploads/app_image/soc-compliance.png" class="compliance-logo" alt="SOC Compliance">
                        <img src="https://cleve.io/uploads/app_image/pci-compliance.webp" class="compliance-logo" alt="ISO 27001 Certification">
                        <img src="https://cleve.io/uploads/app_image/iso-27001.png" class="compliance-logo" alt="ISO 27001 Certification">
                        </div>
                    </div>
                    <div class="col-md-6">
                        <h1>Payer Details</h1>
                        ...
                        <div id="offlinePayment" class="hidden-div">
                            <div class="form-group mb-2">
                                ...
                                <?php
                                    ...
                                    $paymentTypes = $builder->get('saas_offline_payment_types')->result();
                    ...
                    <?php } ?>
                        ...
                        <button type="submit" class="btn btn-block btn-red" data-loading-text="<i class='far fa-spinner fa-spin'></i> Processing">Pay Now</button>
                        <?php echo form_close();?>
                    </div>
                </div>
            </section>
