    ...
    >
      ...
      >
        ...
        <style type="text/css">
            ...
            .text-info {
    --bs-text-opacity: 1;
    color: rgb(158 13 240) !important;
    background: rgb(158 13 240 / 14%) !important;
    border-radius: 15px;
}
.alert-success {
    color: #066c06;
    background-color: #00740c29;
    /* border-color: #599b43; */
}
.status-list li {
    display: inline-block;
...
.sr-root .pasha-image img {
    ...
    /* box-shadow: 0 7px 14px 0 rgba(50, 50, 93, 0.0), 0 3px 6px 0 rgba(0, 0, 0, 0.00); */
            ...
            <div class="sr-main">
                <section class="container">
                    ...
                    if(!empty($schoolRegDetails['payment_data']) && $schoolRegDetails['payment_data'] == 'olp') { 
                        $r = $builder->select('status,comments')->where('school_register_id', $schoolRegDetails['id'])->get('saas_offline_payments')->row();
                        if ($r->status == 3) {
                            ?>
                    ...
                    <div class="invoice-container" id="invoiceDiv">
                        ...
                        <div class="row invoice-header">
                            <div class="invoice-col">
                                ...
                                <h3>INVOICE #<?php echo $schoolRegDetails['reference_no']; ?></h3>
                            </div>
                        ...
                        <div class="btn-group btn-group-sm d-print-none mt-5">
                            ...
                            <a href="<?php echo base_url('saas_website/invoicePDFDownload/' . $schoolRegDetails['reference_no']) ?>"
                                class="btn btn-1"><i class="far fa-download"></i> Download</a>
                            <?php if ($schoolRegDetails['payment_status'] == 0) { 
                                if ($schoolRegDetails['payment_data'] != 'olp') {?>
                            <a href="<?php echo base_url('saas_payment/index/' . $schoolRegDetails['reference_no']) ?>"
                                class="btn btn-primary"><i class="far fa-credit-card"></i> Pay Now</a>
                            <?php } } ?>
                        </div>
                    </div>
                    <div class="text-center mt-4"><a href="<?php echo base_url() ?>"><i class="far fa-angle-double-left"></i> Back To Home</a></div>
                </section>
            </div>
        </div>
