...
<div class="row">
	<div class="col-md-12">
			...
			<?php if (get_permission('leave_manage', 'is_add')): ?>
				<div class="panel-btn">
					<a href="javascript:void(0);" id="addLeave" class="btn btn-default btn-circle" >
						<i class="far fa-plus-circle"></i> Add Leave
					</a>
				</div>
			<?php endif; ?>
			</header>
		...
		<section class="panel appear-animation" data-appear-animation="<?=$global_config['animations'] ?>" data-appear-animation-delay="100">
			<header class="panel-heading">
				<h4 class="panel-title"><i class="far fa-users" aria-hidden="true"></i> <?=translate('leave_list')?></h4>
			</header>
			<div class="panel-body">
				<table class="table table-bordered table-condensed table-hover mb-none table-export" >
					...
					<tbody>
						...
						<tr>
							...
							<td><?php
								echo !empty($row['orig_file_name']) ? '<i class="far fa-paperclip"></i> ' : '';
								if ($row['role_id'] == 7) {
...
<div id="addLeaveModal" class="zoom-anim-dialog modal-block mfp-hide modal-block-lg">
    <section class="panel">
        <div class="panel-heading">
            <h4 class="panel-title"><i class="far fa-plus-circle"></i> <?php echo translate('add_leave'); ?></h4>
        </div>
		    ...
		    <footer class="panel-footer">
		        <div class="row">
		            <div class="col-md-12 text-right">
		                <button type="submit" class="btn btn-default mr-xs" id="savebtn" data-loading-text="<i class='far fa-spinner fa-spin'></i> Processing">
		                    <i class="far fa-plus-circle"></i> <?=translate('apply') ?>
		                </button>
