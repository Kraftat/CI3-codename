		...
		<section class="panel">
            ...
            <?= form_open(current_url()); ?>
				...
				<div class="panel-footer">
					<div class="row">
						<div class="col-md-12">
							<button class="btn btn-default pull-right" type="submit" name="save" value="1"><i class="far fa-plus-circle"></i> <?=translate('save'); ?></button>
						</div>	
					</div>
				</div>
			<?= form_close(); ?>
...
<?php if (get_permission('leave_category', 'is_view')): ?>
	<div class="col-md-<?php if (get_permission('leave_category', 'is_add')){ echo "7"; }else{echo "12";} ?>">
		<section class="panel">
			<header class="panel-heading">
				<h4 class="panel-title"><i class="far fa-list-ul"></i> <?=translate('leave_category') . " " . translate('list')?></h4>
			</header>
			<div class="panel-body">
