		...
		if (screenfull.enabled) {
			$(document).on(screenfull.raw.fullscreenchange, function() {
				if (screenfull.isFullscreen) {
					$('.s-expand').find('i').toggleClass('far fa-expand far fa-expand-arrows-alt');
				} else {
					$('.s-expand').find('i').toggleClass('far fa-expand-arrows-alt far fa-expand');
				}
			});
		}
	}
...
function add_more_allowances() {
	...
	<div class="col-md-2 mt-md text-right"><button type="button" class="btn btn-danger removeAL" ><i class="far fa-times"></i> </button></div></div>');
...
function add_more_deduction() {
	...
	<div class="col-md-2 mt-md text-right"><button type="button" class="btn btn-danger removeDE"><i class="far fa-times"></i> </button></div></div>');
